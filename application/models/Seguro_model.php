...
class Seguro_model extends CI_Model {
    ...
    function getPlanComision($idAsesor, $idGerente,$totalSeguro){
        ...
        function getDatosComisionesAsesor($estado){
            ...
            return $this->db->query("SELECT pci1.id_pago_i, pci1.id_comision,lo.nombreLote  lote,
            re.nombreResidencial as proyecto, pac.totalLote precio_lote,
            ...
            oxcpj.nombre as pj_name, u.forma_pago, pac.porcentaje_abono, 0 as factura, 1 expediente,
            ...
            pci1.pago_neodata, pci1.estatus, pci1.fecha_abono, pci1.id_usuario, oxcpj.nombre, u.forma_pago,pci1.id_pago_i, 
            pac.porcentaje_abono, oxcest.nombre, sed.impuesto, 

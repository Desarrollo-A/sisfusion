...
class Anticipos_model extends CI_Model {
    ...
    public function getAnticipos() {
        ...
        ant.proceso, ant.comentario, CASE WHEN ant.prioridad  = 0 THEN 'Normal' ELSE 'URGENTE' END AS prioridad_nombre, $filtroMonto as montoParcial, pra.mensualidades, ant.numero_mensualidades as mensualidadesBoton, pra.monto_parcialidad as valorTexto
        FROM anticipo ant
        ...
        LEFT JOIN parcialidad_relacion_anticipo pra ON pra.id_anticipo = ant.id_anticipo AND pra.monto_parcialidad IS NOT NULL
        WHERE ant.estatus = 2
        $filtro");

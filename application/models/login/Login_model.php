...
//		var_dump($new_pass);
			...
			$query = $this->db->query("SELECT u.id_usuario, u.id_lider, (CASE u.id_lider WHEN 832 THEN 832 ELSE us.id_lider END) id_lider_2, ge.id_usuario id_lider_3, sb.id_usuario id_lider_4, (CASE  WHEN sb.id_usuario = 7092 THEN 3 WHEN sb.id_usuario = 9471 THEN 607 WHEN sb.id_usuario = 681 THEN 607 WHEN sb.id_usuario = 609

...
//		var_dump($new_pass);
			...
			$query = $this->db->query("SELECT u.id_usuario, u.id_lider, (CASE u.id_lider WHEN 832 THEN 832 ELSE us.id_lider END) id_lider_2, ge.id_usuario id_lider_3, sb.id_usuario id_lider_4,(CASE sb.id_usuario WHEN 7092 THEN 3 WHEN 9471 THEN 607 ELSE 0 END) id_lider_5,u.id_rol, u.id_sede, u.nombre, u.apellido_paterno, u.apellido_materno,

...
class Postventa_model extends CI_Model
{
    ...
    {   
        ...
        GROUP BY  cl.clave_actividad, cl.clasificacion, cl.estatus_actual, cl.tipo_permiso, av.nombre, av.clave, ar2.nombre, av.descripcion) cr ON cr.estatus_siguiente = cp.estatus_siguiente

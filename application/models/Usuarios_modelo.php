    ...
    function getUsersList()
    {
        ...
        switch ($this->session->userdata('id_rol')) {
            ...
            case '5': // ASISTENTE SUBDIRECCIÓN
               ...
               else if($this->session->userdata('id_usuario') == 29 || $this->session->userdata('id_usuario') == 7934) // 29 FERNANDA MONJARAZz
            ...
            case '6': // ASISTENTE GERENCIA
                ...
                else if ($this->session->userdata('id_usuario') == 10795) // ALMA GALICIA ACEVEDO QUEZADA VERRÁ TODOS LOS REGISTROS DE GUADALAJARA
                    $where = "id_rol IN (7, 9, 3) AND usuarios.id_sede = '12'";

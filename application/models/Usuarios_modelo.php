    ...
    function getUsersList(){
        ...
        switch ($this->session->userdata('id_rol')) {
            case '54': // POPEA
                ...
                usuarios.fecha_creacion, UPPER(s.nombre) sede, usuarios.nueva_estructura, usuarios.simbolico, usuarios.tipo,usuarios.fac_humano
                FROM usuarios 
            ...
            case '20': // GERENTE MKTD
                ...
                CONCAT(us2.nombre, ' ', us2.apellido_paterno, ' ', us2.apellido_materno) jefe_directo2, 0 nuevo, u.fecha_creacion, u.nueva_estructura, u.simbolico, u.tipo,usuarios.fac_humano
                FROM usuarios u 
            ...
            case '4': // ASISTENTE DIRECCIÓN
                ...
                usuarios.fecha_creacion, s.nombre sede, usuarios.nueva_estructura, usuarios.simbolico, usuarios.tipo,usuarios.fac_humano
                FROM usuarios 
                INNER JOIN (SELECT * FROM opcs_x_cats WHERE id_catalogo = 1) opcs_x_cats ON usuarios.id_rol = opcs_x_cats.id_opcion 
                LEFT JOIN (SELECT id_usuario AS id_lid, id_lider AS id_lider_2, CONCAT(apellido_paterno, ' ', apellido_materno, ' ', usuarios.nombre) lider FROM usuarios) AS lider_2 ON lider_2.id_lid = usuarios.id_lider 
                LEFT JOIN (SELECT id_usuario, id_lider AS id_lider3, CONCAT(apellido_paterno, ' ', apellido_materno, ' ', usuarios.nombre) lider_coord FROM usuarios) AS lider_3 ON lider_3.id_usuario = lider_2.id_lid 
            ...
            case '5': // ASISTENTE SUBDIRECCIÓN
                ...
                if($this->session->userdata('id_usuario') == 29 || $this->session->userdata('id_usuario') == 7934)
                    ...
                    id_lider, id_lider_2, 0 nuevo, usuarios.fecha_creacion, s.nombre sede, usuarios.nueva_estructura, usuarios.simbolico, usuarios.tipo ,usuarios.fac_humano
                    FROM usuarios 
                    INNER JOIN (SELECT * FROM opcs_x_cats WHERE id_catalogo = 1) opcs_x_cats ON usuarios.id_rol = opcs_x_cats.id_opcion 
            ...
            case '41': // GENERALISTA
                ...
                u.telefono, 
                CASE WHEN u.nueva_estructura = 1 THEN oxcNE.nombre ELSE oxc.nombre END puesto,
                CONCAT(us.nombre, ' ', us.apellido_paterno, ' ', us.apellido_materno) jefe_directo, u.correo, CASE WHEN DAY(u.fecha_creacion) >= 6 AND MONTH(u.fecha_creacion) = MONTH(GETDATE()) AND YEAR(u.fecha_creacion) = YEAR(GETDATE()) THEN 1 ELSE 0 END as nuevo, u.fecha_creacion, s.nombre sede, u.simbolico, u.tipo ,usuarios.fac_humano
                FROM usuarios u 
                LEFT JOIN usuarios us ON us.id_usuario = u.id_lider
                INNER JOIN opcs_x_cats oxc ON oxc.id_opcion = u.id_rol
            ...
            case '55': // POSTVENTA
                ...
                CASE WHEN oxcN.id_opcion = 0 THEN '2D572C' ELSE 'aeaeae' END AS color,oxcn.id_opcion as id_nacionalidad, u.forma_pago as id_forma_pago, u.nueva_estructura, u.simbolico, u.tipo,usuarios.fac_humano
                FROM usuarios u 
                LEFT JOIN usuarios us ON us.id_usuario = u.id_lider
            ...
            case '49': // CONSULTA (CAPITAL HUMANO DESCUENTOS UNIVERSIDAD)
                ...
                (SELECT (MAX(fecha_creacion)) FROM auditoria aud WHERE u.id_usuario = aud.id_parametro AND aud.tabla='usuarios' AND col_afect='estatus' and anterior='1' and (nuevo='0' OR nuevo='3')) as fecha_baja, u.nueva_estructura, u.simbolico, u.tipo,usuarios.fac_humano
                FROM usuarios u 
                LEFT JOIN usuarios us ON us.id_usuario = u.id_lider
                INNER JOIN opcs_x_cats oxc ON oxc.id_opcion = u.id_rol AND oxc.id_catalogo = 1
                LEFT JOIN opcs_x_cats oxc2 ON oxc2.id_opcion = u.forma_pago AND oxc2.id_catalogo = 16
            ...
            case '8': //SOPORTE
                ...
                CONCAT(us.nombre, ' ', us.apellido_paterno, ' ', us.apellido_materno) jefe_directo, u.correo, CASE WHEN DAY(u.fecha_creacion) >= 6 AND MONTH(u.fecha_creacion) = MONTH(GETDATE()) AND YEAR(u.fecha_creacion) = YEAR(GETDATE()) THEN 1 ELSE 0 END as nuevo, u.fecha_creacion, s.nombre sede, u.nueva_estructura, u.simbolico, u.tipo,usuarios.fac_humano
                FROM usuarios u 
                LEFT JOIN usuarios us ON us.id_usuario = u.id_lider
                INNER JOIN opcs_x_cats oxc ON oxc.id_opcion = u.id_rol AND oxc.id_catalogo = 1

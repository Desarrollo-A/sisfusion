...
//		$query = $this->db->get();
    ...
    public function registroClienteDS($id_condominio) {
        ...
        AND idStatusContratacion IN (1, 2, 3) AND idMovimiento IN (31, 85, 20, 63, 73, 82, 92, 96, 99, 104, 108, 109, 111) AND 
    ...
    public function validateSt2($idLote) {
        ...
        $this->db->where("(idStatusContratacion IN (1, 2, 3) AND idMovimiento IN (31, 85, 20, 63, 73, 82, 92, 96, 104, 108, 109, 111))");

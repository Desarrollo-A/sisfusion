...
class Reestructura_model extends CI_Model
{
    ...
    public function getListaClientesReubicar() {
        ...
        oxc1.nombre estatusPreproceso, lo.estatus_preproceso id_estatus_preproceso, pxl3.totalCorridasNumero, pxl4.totalContratoNumero, 
        ...
        lf1.totalCorridaFusion, lf2.totalCorridasFusionNumero, lf3.totalContratosFusion, lf4.totalContratoFusionNumero,
		...
		LEFT JOIN (SELECT idLotePvOrigen, COUNT(*) totalCorridaFusion FROM lotesFusion WHERE destino=1  GROUP BY idLotePvOrigen) lf1 ON  lf1.idLotePvOrigen = lo.idLote

			...
			<div class="modal-dialog">
				<div class="modal-content" >
					<div class="modal-header">
						<h4 class="modal-title text-center"><label>Agregar o editar cláusulas para <b><span id="nombreLote"></span></b></label></h4>
					</div>
					<div class="modal-body">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<label class="control-label">Cláusulas</label>
								<input class="text-modal mb-1" name="clausulas" id="clausulas" autocomplete="off" cols="40" rows="5">
								<br>
							</div>
...
<script src="<?= base_url() ?>dist/js/controllers/caja/clausulasLotesParticulares.js"></script>
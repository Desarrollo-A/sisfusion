                ...
                <div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <h4 class="card-title">Liberación de lotes</h4>
                            <div class="toolbar">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
                                       ...
                                       <div class="col-sm-3"> 
                                        ...
                                        <center><button  class="btn btn-primary btn-round" style="background: #0FC693;"><i class="material-icons">done</i> LIBERAR</button></center>
                                        &nbsp;</div>
                                    </div>
                                </div>
                            </div>

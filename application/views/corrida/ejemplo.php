...
<head>
    <meta charset="UTF-8">
    <title>Data Table con Input de Texto</title>
...
<body>
<div class="">
    <button onclick="getDataTable()">OK</button>
    <table id="countryTable" class="display" cellspacing="0" width="100%">
        <thead>
        <tr>
            <th>País</th>
            <th>Input de Texto</th>
        </tr>
        </thead>
        <tbody>
        <!-- Cada fila se generará automáticamente mediante JavaScript -->
        </tbody>
    </table>
...
<script>
    ...
    $(document).ready(function() {
        ...
        countries.forEach(function(country, index) {
            ...
            table.row.add([country.name, '<input type="text" id="' + inputId + '">']);
        });
    ...
    function getDataTable(){
        ...
        table.data().map((elemento, index)=>{
            console.log('elemento', elemento[0]);
            var input2 = ($('#input'+index).length) ? document.getElementById('input'+index).value : 0; // Obtener el valor del input en la fila actual
            input2 = (input2 == null || input2 == '' || input2 == 0) ? '': input2;
            console.log('input2', input2);

        });
        // table.rows().every(function(index) {
        //     var data = this.data(); // Obtener los datos asociados al registro
        //     var input2 = document.getElementById('input'+index).value; // Obtener el valor del input en la fila actual
        //     datosInputs.push({ datos: data[0], input: input2 }); // Agregar los datos y el valor del input al array
        // });



        // Mostrar el array
        console.log("datosInputs", datosInputs);
    }
</script>
</body>
</html>

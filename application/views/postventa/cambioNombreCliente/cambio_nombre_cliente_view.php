...
<body class="">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="material-datatables">
                                    <div class="form-group">
                                        <table class="table-striped table-hover hide" id="table_cambio_nombre_cliente" name="table_cambio_nombre_cliente">
                                            <thead>
                                                <tr>
                                                    <th>PROYECTO</th>
                                                    <th>CONDOMINIO</th>
    ...
    <script src="<?=base_url()?>dist/js/controllers/postventa/cambioNombreCliente/cambio_nombre_cliente.js"></script>
</body>
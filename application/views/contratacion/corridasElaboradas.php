...
<script>
	$(document).ready(function()
	{
		...
		{
			// $('#showDate').append('<center><h3>Corridas elaboradas al día de hoy: '+data+'</h3></center>');
			$('#showDate').append('Corridas elaboradas al día de hoy: ' + data);
		}).fail(function()
		{
		...
		var table = $('#Jtabla').dataTable( {
			"ajax":
				{
					"url": '<?=base_url()?>index.php/contratacion/getCorridasElaboradas',
					"dataSrc": ""
				},
			"select": true,
			"scrollX":        true,

			...
			<div class="row">
				<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="col col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<h5>
							Bienvenido/a 	<?=$this->session->userdata('nombre')?> <?=$this->session->userdata('apellido_paterno')?> <?=$this->session->userdata('apellido_materno')?>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 hide">

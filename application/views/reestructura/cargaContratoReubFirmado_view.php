                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="encabezadoBox">
                                <h3 class="card-title center-align">Carga de contrato reubicacion firmado</h3>
                                <p class="card-title pl-1"></p>
                            </div>
                            <div class="material-datatables">
                                <table id="cargaContratorReubFirmadoTabla" class="table-striped table-hover">
                                    <thead>
                                    <tr>
                                        <th>PROYECTO</th>
                                        <th>CONDOMINIO</th>
...
<script src="<?=base_url()?>dist/js/controllers/reestructura/cargaContratoReubFirmado.js"></script>

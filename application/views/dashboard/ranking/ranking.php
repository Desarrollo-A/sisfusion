                    ...
                    <div class="row h-100">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-chart h-100">
                            <div class="d-flex justify-between h-10 actions">
                                ...
                                <button class="btn-charts" onclick="toggleDatatable(this)" rel="tooltip" data-placement="bottom" title="Mostrar tabla" data-i18n-tooltip="mostrar-tabla"><i class="far fa-list-alt"></i></button>
                            </div>
                            <div id="boxChart" class="h-80 boxChartRanking">
                                <div id="chart" class="chart h-100"></div>
                            </div>
                            <div class="h-10">
                                <h5 class="m-0 text-center titles" data-i18n="ventas-de-apartados">Ventas de apartados</h5>
                            </div>
                        </div>
                ...
                <div class="container-fluid h-100">
                    <div class="row h-100">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-chart h-100">
                            ...
                            <div class="h-10">
                                <h5 class="m-0 text-center titles" data-i18n="ventas-con-contrato">Ventas con contrato</h5>
                            </div>
                        </div>
                ...
                <div class="container-fluid h-100">
                    <div class="row h-100">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-chart h-100">
                            ...
                            <div class="h-10">
                                <h5 class="m-0 text-center titles" data-i18n="ventas-con-enganche">Ventas con enganche</h5>
                            </div>
                        </div>
                    ...
                    <div class="row h-100">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-chart h-100">
                            <div class="d-flex justify-between h-10 actions">
                                ...
                                <button type="btn" class="btn-charts"  rel="tooltip" data-placement="bottom" title="Mostrar tabla" onclick="toggleDatatable(this)" data-i18n-tooltip="mostar-tabla"><i class="far fa-list-alt"></i></button>
                            </div>
                            <div id="boxChart4" class="h-80 boxChartRanking">
                                <div id="chart4" class="chart"></div>
                            </div>
                            <div class="h-10">
                                <h5 class="m-0 text-center titles" data-i18n="ventas-sin-enganche">Ventas sin enganche</h5>
                            </div>
                        </div>

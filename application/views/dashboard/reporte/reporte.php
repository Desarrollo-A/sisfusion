...
<div class="container-fluid">
    <div class="row pdt-40" id="tableFilters">
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 pb-1 overflow-hidden">
            <select class="selectpicker select-gral m-0" name="estatusContratacion" id="estatusContratacion" data-style="btn" data-show-subtext="true" data-live-search="true" data-i18n-label="selecciona-una-opcion" 
            title="SELECCIONA UNA OPCIÓN" data-size="7" data-container="body" required></select> 
        </div>
            ...
            <div class="card p-0 cardMiniChart" id="cardMiniChart">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <button type="btn" class="moreMiniChart d-flex justify-center align-center" data-toggle="tooltip" data-placement="left" title="MÁS DETALLE" data-i18n-tooltip="mas-detalle" onclick="chartDetail(this, 'cc')" data-name ="canceladas_contratadas">
                            <i class="fas fa-expand-alt"></i>
                        </button>
                    </div>
                </div>
            ...
            <div class="card p-0 cardMiniChart" id="cardMiniChart">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <button type="btn" class="moreMiniChart d-flex justify-center align-center" data-toggle="tooltip" data-placement="left" title="MÁS DETALLE" data-i18n-tooltip="mas-detalle" onclick="chartDetail(this, 'ca')" data-name ="canceladas_apartadas">
                            <i class="fas fa-expand-alt"></i>
                        </button>
                    </div>
                </div>

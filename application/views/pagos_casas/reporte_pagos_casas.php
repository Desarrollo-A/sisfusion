...
<body class="">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="nav nav-tabs nav-tabs-cm">
                            <li class="active">
                                <a href="#reporteCasasActivo" role="tab" data-toggle="tab" onclick="dataFunction(1)">Procesos Activos</a>
                            </li>
                            <li>
                                <a href="#reporteCasasFinalizado" role="tab" data-toggle="tab" onclick="dataFunction(2)">Procesos Finalizados</a>
                            </li>
                        </ul>
                            ...
                            <div class="card-content p-0">
                                <div class="nav-tabs-custom">
                                    <div class="tab-content p-2">
                                        ...
                                        <div class="tab-pane active" id="reporteCasasActivo">
                                            <div class="card-content">
                                                <div class="toolbar">
                                                    <h3 class="card-title center-align">Procesos activos</h3>
                                        ...
                                        <div class="tab-pane" id="reporteCasasFinalizado">
                                            <div class="card-content">
                                                <div class="toolbar">
                                                    <h3 class="card-title center-align">Procesos finalizados</h3>
                                                    <div id="table-filters" class="row mb-1"></div>
                                                </div>
    ...
    <script src="<?= base_url() ?>dist/js/controllers/pagos_casas/reporte_pagos_casas.js"></script>
</body>
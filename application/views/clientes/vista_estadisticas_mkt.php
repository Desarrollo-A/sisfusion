					...
					<div class="container-fluid">
						<div class="card" >
							...
							<div class="card-content">
								<h4 class="card-title"> Estadísticas <span><b>marketing digital</b></span></h4>
								<div class="row">
												...
												<div class="row">
													...
													<div class="col-md-6">
														...
														<div class="row">
															...
															<div class="col-md-6 form-group" style="font-family: 'Source Sans Pro', 'Helvetica Neue', Helvetica, Arial, sans-serif;">
																<label>Asesor</label>

                            ...
                            <form id="my-form" name="my-form" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input id="name" name="name" type="text" class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();" onchange="validateInputs(this);">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group label-floating">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input id="email" name="email" type="email" class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();" onchange="validateInputs(this);">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">* Teléfono celular<small> (requerido)</small></label>
                                                    <input id="phone_number" name="phone_number" type="number" class="form-control" maxlength="15" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onchange="validateInputs(this);">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Teléfono casa</label>
                                                    <input id="phone_number2" name="phone_number2" type="number" class="form-control" maxlength="15" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                                </div>
                                            </div>
                                            <div class="col-sm-2 col-sm-offset-1">
                                                <div class="form-group label-floating select-is-empty">
                                ...
                                <div class="wizard-footer">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <button type='button' class='btn btn-finish btn-fill btn-green btn-wd' name='finish' id="finish" value='Finalizar'  style="background-color: #4caf50"/>Finalizar</button>

        ...
        <div class="modal-dialog modal-md ">
            <div class="modal-content">
                ...
                <div class="modal-footer text-center">
                    <button type="button" class="btn btn-simple" data-dismiss="modal">Cancelar<div class="ripple-container">
                            <div class="ripple ripple-on ripple-out" style="left: 40.9625px; top: 23.8px; background-color: rgb(153, 153, 153); transform: scale(12.7953);"></div></div></button>
    ...
    <div class="modal fade in" id="preguntaEnviarContraloria" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer text-center">
                    <button type="button" class="btn btn-simple" data-dismiss="modal" onclick="cleanElement()">Cancelar<div class="ripple-container">
                            <div class="ripple ripple-on ripple-out" style="left: 40.9625px; top: 23.8px; background-color: rgb(153, 153, 153); transform: scale(12.7953);"></div></div></button>
    ...
    <div class="modal fade in" id="preguntaDeleteMktd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
        <div class="modal-dialog modal-md ">
            <div class="modal-content">
                ...
                <div class="modal-footer text-center">
                    <button type="button" class="btn btn-simple" data-dismiss="modal" onclick="cleanComments()">Cancelar<div class="ripple-container">
                            <div class="ripple ripple-on ripple-out" style="left: 40.9625px; top: 23.8px; background-color: rgb(153, 153, 153); transform: scale(12.7953);"></div></div></button>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" >
                <form id="subir_evidencia_formE" name="subir_evidencia_formE" method="post">
                    ...
                    <div class="modal-footer">
                        <a href="#" class="btn btn-primary" onclick="return validateEmptyFieldsE()" id="btnSubmitE"> Enviar autorización
                        </a>
            ...
            <div class="row">
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="nav nav-tabs nav-tabs-cm">
                        ...
                        <li><a href="#controversy" data-toggle="tab" onclick="javascript:$('#controversyTable').DataTable().ajax.reload();">Agregar controversia</a></li>
                        <?php
                                        ...
                                        <div class="table-responsive">
                                            <table id="checkEvidencia" class="table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th data-toggle="tooltip" data-placement="right" title="Fecha apartado">FECHA APARTADO</th>
                                                    ...
                                                    <th data-toggle="tooltip" data-placement="right" title="Solicitante">SOLICITANTE</th>
                                                    ...
                                                    <th data-toggle="tooltip" data-placement="right" title="Validación gerente">VALIDACIÓN GERENTE</th>
                                                    <th data-toggle="tooltip" data-placement="right" title="Validación cobranza">VALIDACIÓN COBRANZA/th>
                                                    <th data-toggle="tooltip" data-placement="right" title="Validación contraloría">VALIDACIÓN CONTRALORIA</th>
                                                    <th data-toggle="tooltip" data-placement="left" title="Rechazo cobranza">RECHAZO COBRANZA</th>
                                                    <th data-toggle="tooltip" data-placement="left" title="Rechazo contraloría">RECHAZO CONTRALORÍA</th>
                                                    <th data-toggle="tooltip" data-placement="left" title="Lugar prospección">LUGAR PROSPECCIÓN</th>
                                            ...
                                            <form method="POST" name="formControversias" id="formControversias" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-2 pl-0">
                                                            <div class="form-group label-floating">
                                                                <button type="submit" class="btn-gral-data">Agregar</button>
                                                ...
                                                <div class="table-responsive">
                                                    <table id="controversyTable" class="table-striped table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th data-toggle="tooltip"title="Fecha creación">FECHA CREACIÓN</th>
...
<script>
    $(document).ready (function() {
        ...
        // tablaEvidencias = $('#autorizarEvidencias').DataTable( {
        ...
        //     destroy: true,
        //     ordering: false,
        //     ajax: "<?=base_url()?>index.php/Asesor/getAutsForCobranza/",
        //     columns: [
        //         { "data": "idLote" },
        //         { "data": "nombreLote" },
        //         { "data": "nombreCliente" },
        ...
        //                 let buttonTwo;
        //                 let labelStatus;
        //                 button = '<button class="btn-data btn-green revisarSolicitud center-items" data-evidencia="'+d.evidencia+'" data-id_evidencia="'+d.id_evidencia+'"' +
        //                     ' data-idCliente="'+d.id_cliente+'" data-nombrelote="'+d.nombreLote+'" data-idLote="'+d.idLote+'"' +
        //                     ' data-nombreCliente="'+d.nombreCliente+'"><i class="fas fa-key"></i></button>';

        //                 buttonTwo = '<button title= "Eliminar MKTD de esta venta" data-idLote="'+d.idLote+'" class="btn-data btn-gray delete_mktd center-items"><i class="fas fa-trash"></i></button>';

        //                 let btns = "<div class='d-flex justify-center'>"+ button + buttonTwo +"</div>"
                ...
                },
                {
                    "data": function (d) {
                        if (d.rowType == 1) { // MJ: EVIDENCA NATURAL: SIEMPRE HA SIDO MKTD
                            ...
                            return "<small class='label bg-green' style='background-color: #E67E22'>CONTROVERSIA (PARA DESCUENTO)</small>"
                        } else if (d.rowType == 33) {// MJ: EVIDENCIA DE UNA CONTROVERSIA (PARA DESCUENTO): NO ES VENTA MKTD
                            return "<small class='label bg-green' style='background-color: #0b2f77'>VENTA NUEVA</small>"
                        }
                    }
                },
                ...
                },
                {
                    "data": function (d) {
                        if (d.tipo == 1) { // MJ: CONTROVERSIA NORMAL
                            return "<small class='label bg-green' style='background-color: #2ECC71'>Normal</small>";
                        } else if (d.tipo == 2) {// MJ: CONTROVERSIA PARA DESCUENTO
                            return "<small class='label bg-green' style='background-color: #F1C40F'>Para descuento</small>"
                        } else if(d.tipo == 3){ //Implementación Venta nueva
                            return "<small class='label' style='background-color: #0b2f77'>Venta nueva</small>";
                        }
                    }
                },
                { "data": "comentario" },

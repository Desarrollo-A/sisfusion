                                            ...
                                            <div class="row">
                                                <h4 class="card-title">Carga masiva de prospectos</h4>
                                                            ...
                                                            <div class="col-md-12" id="savingProspect">
                                                              <input type="text" name="" id="inpunt1" value="10000.236476727">
                                                              <input type="text" name="" id="inpunt2">
                                                            <button type="reset" onclick="toFixedValidation();" class="btn">Limpiar</button>
</div>
</div>
...
<script>
    ...
    function toFixedValidation(){
      var v = parseFloat($("#inpunt1").val());
       $("#inpunt2").val(v.toFixed(2));
    };
function limpiar()
{

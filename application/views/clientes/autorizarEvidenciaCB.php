                ...
                <div class="row">
                    <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="nav nav-tabs nav-tabs-cm">
                            <li class="active"><a href="#soli" data-toggle="tab" onclick="javascript:$('#autorizarEvidencias').DataTable().ajax.reload();">EVIDENCIAS</a></li>
                ...
                columns: [
                    ...
                    { "data": "fechaApartado" },
                    {
                        "data": function( d ){
                            ...
                            let btns = "<div style='display:flex; justify-content: center'>"+ button + buttonTwo +"</div>"

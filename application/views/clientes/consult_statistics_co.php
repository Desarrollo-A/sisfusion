                                    ...
                                    <!--<form id="formUsuario" name="formUsuario"  >-->
                                        <div class="row">
                                            <div class="row">
                                                ...
                                                <!-- esto se le quito del select: ng-change="changeetapa()" -->
                                                <div class="col-md-6">
                                                    <div class="row">
...
<script>
    ...
    myApp.controller('datos',
        function ($scope, $http) {
            ...
            var request = {
                method: 'get',
                url: 'Statistics/get_total_coordinador',
                dataType: 'json',
            ...
            $http({
                method: 'get',
                url: 'Statistics/get_asesores_coord'
            ...
            $scope.exportData1 = function (data) {
                ...
                if(a == "" || b == "" || c == undefined || d == undefined){
                    ...
                    $scope.asesorInvalido = $scope.formUsuario.asesoresSelect.$valid;
                    $scope.myStyle = {'color':'red'}

                    //angular.element.blockUI()
                    request = {
                        method: 'POST',
                        url: 'Statistics/get_repo_coord_general1'
                    };
                    $http(request)
                        .then(function (jsonData) {
                    ...
                    request = {
                        method: 'POST',
                        url: 'Statistics/get_repo_coord1',
                        data: JSON.stringify({tipo : data.etapa, asesor : data.asesor, fecha_ini : data.fecha1, fecha_fin : data.fecha2})
                    };
                    $http(request)
                        .then(function (jsonData) {

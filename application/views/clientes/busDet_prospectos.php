											...
											<div class="row">
												<div class="col-12 col-sm-12 col-md-6 col-lg-6">
													<div class="form-group label-floating is-empty">
														<label class="control-label label-gral" data-i18n="nombre-2">Nombre</label>
												...
												<div class="col-12 col-sm-12 col-md-6 col-lg-6">
													<div class="form-group label-floating is-empty">
														<label class="control-label label-gral" data-i18n="correo-2">Correo</label>
												...
												<div class="col-12 col-sm-12 col-md-6 col-lg-6">
													<div class="form-group">
														<div class="row">
															<div class="col-12 col-sm-12 col-md-6 col-lg-6">
																<button class="btn-data-gral btn-s-blue" id="buscarBtn"><i class="fas fa-search"></i> <span data-i18n="buscar">Buscar</span></button>
															</div>
															<div class="col-12 col-sm-12 col-md-6 col-lg-6">
																<button class="btn-data-gral btn-s-deepGray"id="ResetForm" type="reset"><i class="fas fa-eraser" ></i> <span data-i18n="limpiar-campos">Limpiar campos</span></button>
															</div>
														</div>
													</div>
												</div>

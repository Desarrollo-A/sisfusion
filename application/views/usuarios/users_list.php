                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group label-floating select-is-empty div_payment_method">
                                                            ...
                                                            <select id="payment_method" name="payment_method" class="form-control payment_method" required disabled="true"></select>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
...
<div id="ch">       
    <p ><b>Los siguientes campos (SEDE CAPITAL HUMANO y SUCURSAL CAPITAL HUMANO) son información que se solicita de manera adicional para mantener actualizado tanto el sistema de Capital Humano como CRM actualizados.</b></p>
<p><b>Llenado:  SEDE CAPITAL HUMANO (sede de asignación del asesor), SUCURSAL CAPITAL HUMANO (Oficina en la que se encuentra ubicado el asesor).</b></p>
                                                    <div class="col-sm-6">
                                                        <div class="form-group label-floating select-is-empty div_leader">
                                                            <label class="control-label">SEDE CAPITAL HUMANO</label>
                                                            <select id="sedech" name="sedech" class="form-control sedech" ></select>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group label-floating select-is-empty div_leader">
                                                            <label class="control-label">SUCURSAL CAPITAL HUMANO (no requerido)</label>

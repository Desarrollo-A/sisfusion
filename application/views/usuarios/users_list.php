                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-sm-3" id="tipoMiembro_column">
                                    <div class="form-group overflow-hidden">
                                        <label class="control-label"><span dat-i18n="rol">Rol</span> (<small class="isRequired">*</small>)</label>
                                        <select class="selectpicker select-gral m-0" id="member_type" name="member_type" data-style="btn" data-show-subtext="true" data-live-search="true" data-i18n-label="selecciona-una-opcion" title="SELECCIONA UNA OPCIÓN" data-size="7" data-container="body" required onchange="getLeadersList()"></select>
                                    </div>
                                </div>

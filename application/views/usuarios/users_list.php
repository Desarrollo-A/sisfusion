                                        ...
                                        <div class="material-datatables">
                                            <table id="all_users_datatable" class="table-striped table-hover"
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="disabled-sorting text-right"><center>COORDINADOR</center></center></th>
                                                    ...
                                                    <th class="disabled-sorting text-right"><center>TALLA</center></th>
                                                    <th class="disabled-sorting text-right"><center>GÉNERO</center></th>
                                                    <th class="disabled-sorting text-right"><center>HIJOS + 12</center></th>
                                                    <th class="disabled-sorting text-right"><center>REINGRESO</center></th>
                                                    <th class="disabled-sorting text-right"><center>BAJA</center></th>

...
<body class="">
    <div class="wrapper">
        <?php
		    if(in_array($this->session->userdata('id_rol'), array(2, 3, 4, 5, 6, 7, 8, 9, 11, 12, 13, 15, 16, 17, 19, 28, 32, 33, 34, 39, 40, 47, 50, 53, 54, 55, 58, 65, 70, 71, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83)) || ($this->session->userdata('id_rol') == 11 && $this->session->userdata('id_usuario') == 2755) || $this->session->userdata('id_usuario') == 2748)

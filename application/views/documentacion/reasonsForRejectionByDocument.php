                        ...
                        <div class="modal-body text-center boxContent p-0">
                            <div class="card no-shadow p-0">
                                <div class="card-content p-0">
                                    <h3 class="card-title center-align">Ingresa el motivo de rechazo que asociarás a <b>
                                            <p id="documentName"></p>
                                        </b></h3>
                                    <div class="toolbar">
                ...
                <div class="row">
                    <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="nav nav-tabs nav-tabs-cm">
                            <li class="active">
                                <a href="#documento" role="tab" id="solicitudes_tabla" data-toggle="tab">Rechazo por documento</a>
                            </li>

                            <li>
                                <a href="#solicitudes" role="tab" id="testimonio_tabla" data-toggle="tab">Rechazo por solicitud</a>
                            </li>
                        </ul>
                            ...
                            <div class="card-content">
                                <div class="nav-tabs-custom">
                                    <div class="tab-content p-2">
                                        <div class="tab-pane active" id="documento">
                                        ...
                                        <div class="tab-pane" id="solicitudes">
                                            <div class="encabezadoBox">
                                                <h3 class="card-title center-align">Administrador - motivos de rechazo por solicitud</h3>
                                            </div>
                                            <div class="toolbar">
                                                <div class="row aligned-row">
                                                    <div class="col col-xs-12 col-sm-12 col-md-9 col-lg-2">

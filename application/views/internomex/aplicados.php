                                        ...
                                        <div class="content">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    <h4 class="card-title" >COMISIONES NUEVAS - <b>INTERNOMEX</b></h4><p class="category">Comisiones solictadas para proceder a pago.</b></p>
                                                    </div>
...
"columns": [
    ...
    "ajax": {
        "url": url2 + "Internomex/getDatosAplicadosInternomex/" + proyecto + "/" + condominio,
        "type": "POST",
        cache: false,
        "data": function( d ){
                }

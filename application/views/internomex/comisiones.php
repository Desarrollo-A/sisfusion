    ...
    <div class="wrapper">
            ...
            <div class="modal-dialog" style="width:520px;">
                <div class="modal-content">
                    <div class="modal-header bg-red">
                        <h4 class="modal-title" data-i18n="aprobar-comision">APROBAR PAGO DE COMISIÓN</h4>
                    </div>
        ...
        <div class="modal fade modal-alertas" id="modal_prev_fac" role="dialog">
            <div class="modal-dialog" style="width:520px; margin-top:20px">
                <div class="modal-content">
                    <div class="modal-header bg-red">
                        <h4 class="modal-title" data-i18n="datos-factura">DATOS DE FACTURA</h4>
                    </div>
        ...
        <div class="modal fade modal-alertas" id="modal_pausar" role="dialog">
            <div class="modal-dialog" style="width:520px;">
                <div class="modal-content">
                    <div class="modal-header bg-red">
                        <h4 class="modal-title" data-i18n="comision-espera">COMISIÓN EN ESPERA</h4>
                    </div>
        ...
        <div class="modal fade modal-alertas" id="modal_reactivacion" role="dialog">
            <div class="modal-dialog" style="width:520px;">
                <div class="modal-content">
                    <div class="modal-header bg-red">
                        <h4 class="modal-title" data-i18n="reactivar-comision">REACTIVAR COMISIÓN</h4>
                    </div>
                                        ...
                                        <div class="nav-center">
                                            <ul class="nav nav-pills nav-pills-internomex nav-pills-icons" role="tablist">
                                                <li class="active" style="margin-right: 50px;">
                                                    <a href="#factura-1" role="tab" data-toggle="tab" data-i18n="por-pagar-factura">
                                                ...
                                                <li style="margin-right: 50px;">
                                                    <a href="#asimilados-2" role="tab" data-toggle="tab" data-i18n="por-pagar-asimilados">
                                                        Por pagar asimilados
                                                    </a>
                                                </li>

                                                <li style="margin-right: 50px;">
                                                    <a href="#espera-3" role="tab" data-toggle="tab" data-i18n="pagos-espera">
                                                        pagos en espera
                                                    </a>
                                                </li>
                                            </ul>
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="col xol-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                                            <h4 class="card-title" data-i18n="comision-nueva-factura">COMISIONES NUEVAS - FACTURA</h4>
                                                                            <p class="category" data-i18n="info-comisiones">Las comisiones con factura se encuentran en espera de dispersión de pago.</p>
                                                                        </div>

                                                                        <div class="col xol-xs-6 col-sm-6 col-md-6 col-lg-6"><br>
                                                                            <label style="color: #0a548b;">&nbsp;<span data-i18n="total-pagar"> Total a pagar: </span> $<input style="border-bottom: none; border-top: none; border-right: none;  border-left: none; background: white; color: #0a548b; font-weight: bold;" disabled="disabled" readonly="readonly" type="text" name="myText_nfact" id="myText_nfact"></label>
                                                                        </div>
...
<script>
    ...
    $("#tabla_otras_comisiones").ready(function() {
        ...
        tabla_otras = $("#tabla_otras_comisiones").DataTable({
            ...
            "ajax": {
                "url": url2 + "Comisiones/getDatosInternomexPausadas",
                /*registroCliente/getregistrosClientes*/
                "type": "POST",
                cache: false,
                "data": function(d) {}

                                        ...
                                        <div class="content">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                <div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                    <h4 class="card-title" ><b>COMISIONES ACTIVAS</b></h4>
                                                                    <!-- <p class="category">Comisiones solictadas por colaboradores para proceder a pago sin factura.</b></p> -->
                                                                    <p class="category"><i class="material-icons">info</i> Comisiones sin saldo disponible en NEODATA, ya dispersadas con anterioridad.</p>
    ...
    if(data.totalNeto2==null) {
        ...
        if(data.compartida==null) {
            BtnStats = '<button href="#" value="'+data.idLote+'" data-estatus="'+data.idStatusContratacion+'"  data-value="'+data.registro_comision+'" data-code="'+data.cbbtton+'" ' +
             ...
             '<span class="material-icons">verified_user</span></button><button href="#" data-idpagoc="' + data.idLote + '" ' +'class="btn btn-success btn-round btn-fab btn-fab-mini update_bandera" style="background-color: #76448A;" title="Regresar a dispersión">' +'<span class="material-icons">autorenew</span></button><button class="btn btn-warning btn-round btn-fab btn-fab-mini marcar_pagada" title="Marcar como liquidada" value="' + data.idLote +'" color:#fff;"><i class="material-icons">how_to_reg</i></button>&nbsp;&nbsp;';
            }else {
                BtnStats = '<button href="#" value="'+data.idLote+'" data-estatus="'+data.idStatusContratacion+'" data-value="'+data.registro_comision+'"  data-code="'+data.cbbtton+'" ' +
            ...
            // BtnStats = '<button href="#" data-idpagoc="' + data.id_pagoc + '" ' +'class="btn btn-success btn-round btn-fab btn-fab-mini update_bandera" style="background-color: #76448A;" title="Regresar a dispersión">' +'<span class="material-icons">autorenew</span></button><button class="btn btn-warning btn-round btn-fab btn-fab-mini marcar_pagada" title="Marcar como liquidada" value="' + data.idLote +'" color:#fff;"><i class="material-icons">how_to_reg</i></button><button class="btn btn-danger btn-round btn-fab btn-fab-mini pausar" title="Rescisión de contrato" value="' + data.idLote +'" color:#fff;"><i class="material-icons">do_not_disturb</i></button>';

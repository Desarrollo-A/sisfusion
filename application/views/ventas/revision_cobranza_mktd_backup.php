...
} ,
{
    ...
    "data": function( d ){
                        ...
                        if (d.ubicacion_dos == null) {
                            return '<p style="font-size: .8em; color:red;"><b>Sin lugar de venta asignado</b></p>';
                        } 
                        else {
...

{
    ...
    "data": function( d ){
        ...
        if(d.id_ub_origen == 3 || d.id_ub_origen == '3'){
...
return lblStats;
            ...
            columnDefs: [{
                ...
                'render': function(d, type, full, meta) {
                    ...
                    if(full.id_ub_origen == 3 && (full.estatus == 1 || full.estatus ==61 )){ 

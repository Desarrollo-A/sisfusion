...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-header card-header-icon" data-background-color="goldMaderas"><i class="fas fa-book fa-2x"></i></div>
    ...
    <script src="<?= base_url() ?>dist/js/controllers/ventas/historial_prestamos.js"></script>
</body>
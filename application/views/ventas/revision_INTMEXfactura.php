...
<body>
    ...
    <script>
        ...
        $('#filtro33').change(function(ruta){
            ...
            $.ajax({
                url: '<?=base_url()?>Comisiones/lista_usuarios/'+residencial+"/"+2,
                type: 'post',
                dataType: 'json',
        ...
        $(document).on("click", ".Pagar", function() {            
            ...
            $('#desarrolloSelect').change(function() {
                ...
                $.getJSON(url + "Comisiones/getPagosByProyect/"+valorSeleccionado+"/"+2).done(function(data) {
                    let sumaComision = 0;
                    console.log(data[0]);
                    if (!data) {
            ...
            tabla_remanente2 = $("#tabla_remanente").DataTable({
                ...
                },
                {
                    ...
                    "data": function( data ){
                        ...
                        '<button href="#" value="'+data.id_pago_i+'" data-value="'+data.id_pago_i+'" data-code="'+data.cbbtton+'" ' + 'class="btn-data btn-orangeYellow cambiar_estatus" title="Pausar solicitud">' + '<span class="material-icons">block</span></button>'
                        */ 
                    }
                }],
                columnDefs: [{
                ...
                ajax: {
                    "url": url2 + "Comisiones/getDatosNuevasFContraloria/" + proyecto + "/" + condominio,
                    "type": "POST",
                    cache: false,
                    "data": function( d ){
                    }

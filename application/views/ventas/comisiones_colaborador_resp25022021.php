                                            ...
                                            <ul class="nav nav-pills nav-pills-info nav-pills-icons" role="tablist">
                                                ...
                                                <li style="margin-right: 50px;">
                                                    <a href="#sin_pago_neodata" role="tab" data-toggle="tab">
                                                        <i class="material-icons" aria-hidden="true">money_off</i> Sin pago en NEODATA
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                            ...
                                                                            <p class="category">Comisiones nuevas <b>disponibles</b> para solicitar tu pago, si requieres ver más detalles puedes consultarlo en el <a href="https://maderascrm.gphsis.com/Comisiones/historial_colaborador">Historial</a>.</p>
                                                                            <p class="estado_horario"></p>
                                                                            <!-- <p>Recuerda que tus comisiones se pagaran con IVA incluido</p> -->

                                                                        </div>
<!-- 

                                                                         <div class="col xol-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                                            <h4 class="card-title">SALDO GENERAL</h4>
                                                                     ...
                                                                     <!--    <div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                                <button class="btn btn-info text-right EnviarMultiple" style="background-color: #003D82;"><i class="fa fa-money" aria-hidden="true"></i>  Enviar comisiones de forma masiva</button>
                                                                        </div> -->
                                                                                            ...
                                                                                            <table class="table table-responsive table-bordered table-striped table-hover" id="tabla_nuevas_comisiones" name="tabla_nuevas_comisiones" style="text-align:center;">
                                                                                                <thead>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <th style="font-size: .8em;">PAG. CLIENTE</th>
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="col xol-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                                            ...
                                                                            <p class="category">Las comisiones se encuentran en revisión por el área de <b>Contraloría.</b></p>
                                                                        </div>
                                                                    ...
                                                                    <div class="card-content">
                                                                        <div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                            <div class="material-datatables">
                                                                                <div class="form-group">
                                                                                    <div class="table-responsive">
                                                                                        <table class="table table-responsive table-bordered table-striped table-hover" id="tabla_revision_comisiones" name="tabla_revision_comisiones" style="text-align:center;">
                                                                                            <thead>
                                                                                                <tr>
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="col xol-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                                            ...
                                                                            <p class="category">Las comisiones se encuentran en proceso de pago por parte de <B>INTERNOMEX.</B></p>
                                                                        </div>
                                                                            ...
                                                                            <div class="material-datatables">
                                                                                <div class="form-group">
                                                                                    <div class="table-responsive">
                                                                                        ...
                                                                                        <table class="table table-responsive table-bordered table-striped table-hover" id="tabla_pagadas_comisiones" name="tabla_pagadas_comisiones" style="text-align:center;">
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-header">
                                                                        ...
                                                                        <div class="col xol-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                                            ...
                                                                            <p class="category">Comisiones pausadas, rechazadas.</p>
                                                                        </div>
                                                                    ...
                                                                    <div class="card-content">
                                                                        <div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                            <div class="material-datatables">
                                                                                <div class="form-group">
                                                                                    <div class="table-responsive">
                                                                                        <table class="table table-responsive table-bordered table-striped table-hover" id="tabla_otras_comisiones" name="tabla_otras_comisiones" style="text-align:center;">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    <th style="font-size: .8em;">ID</th>
                                                                                                    <th style="font-size: .8em;">LOTE</th>
                                                            ...
                                                            <div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                <div class="card">
                                                                    <div class="card-header">
                                                                        <div class="row">
                                                                            <div class="col xol-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                                                <h4 class="card-title">ESTATUS COMISIONES</h4>
                                                                                <p class="category">Comisiones sin pago reflejado en NEODATA.</p>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <?php ?>
	                                                                        <div class="row">
	                                                                            <div class="col-md-6 form-group">
	                                                                                ...
	                                                                                <select name="proyecto" id="proyecto" class="selectpicker" data-style="btn btn-second"data-show-subtext="true" data-live-search="true" title="Selecciona una opción" data-size="7" required>
	                                                                            ...
	                                                                            <div class="col-md-6 form-group">
	                                                                                ...
	                                                                                <select name="condominio" id="condominio" class="selectpicker" data-style="btn btn-second"data-show-subtext="true" data-live-search="true"  title="Selecciona una opción" data-size="7" required>
                                                                    ...
                                                                    <div class="card-content">
                                                                        <div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                            <div class="material-datatables">
                                                                                <div class="form-group">
                                                                                    <div class="table-responsive">
                                                                                        <table class="table table-responsive table-bordered table-striped table-hover" id="tabla_comisiones_sin_pago" name="tabla_comisiones_sin_pago" style="text-align:center;">
                                                                                            <thead>
                                                                                            <tr>
                                                                                                <th style="font-size: .8em;">ID</th>
                                                                                                ...
                                                                                                <th style="font-size: .8em;">ASESOR</th>
                                                                                                <th style="font-size: .8em;">COORDINADOR</th>
                                                                                                <th style="font-size: .8em;">GERENTE</th>
                                                                                                <th style="font-size: .8em;">ESTATUS</th>
                                                                                            </tr>
                                                                                            </thead>
                                                                                        </table>
...
<script>
            ...
            "buttons": [{
                ...
                action: function() {
                    if ($('input[name="idT[]"]:checked').length > 0) {
                        ...
                        $.get(url + "Comisiones/acepto_comisiones_user_dos/" + idcomision).done(function() {
                            var fecha = new Date();
                            if (fecha.getHours() >= 17 && fecha.getDay() == 5) { //miercoles 3 fecha.getHours()>=10 && f
          ...
          exportOptions: {
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "data": function(d) {
                        if (d.estatus == 3) {
                            return '<p style="font-size: .8em"><span class="label" style="background:#ECE624;"> ' + d.estatus_actual + ' </span></p>';
                        } else {
                            ...
                            switch (d.forma_pago) {
                                ...
                                case '2': //FACTURA
                                case 2: //FACTURA
                                    return '<p style="font-size: .8em"><span class="label" style="background:#B3B4B4;">SIN DEFINIR FORMA DE PAGO</span><br><span class="label" style="background:#EED943; color:black;">REVISAR CON RH</span></p>';
                                    break;

                                // case '2': //FACTURA
                                // case 2: //FACTURA

                                //     if (d.factura != null && d.factura != 0 && d.factura != '' && d.expediente != null && d.expediente != 0 && d.expediente != '') {
                                ...
                                case 4: //RD
                                 if (d.expediente == null || d.expediente == 0 || d.expediente == '') {
                                        ...
                                        return '<p style="font-size: .8em"><span class="label" style="background:#6D527E;">REMANENTE DISTRIBUIBLE</span></p><p style="font-size: .8em"><span class="label" style="background:#00B397;">LISTA PARA APROBAR</span></p>';
                                    }
                                    break;
                ...
                // },
                {
                    ...
                    "data": function(d) {
                        ...
                        if (d.estatus == 3) {
                            // return '<p style="font-size: .8em"><span class="label" style="background:#ECE624;"> ' + d.estatus_actual + ' </span></p>';
                            return '<button class="btn btn-round btn-fab btn-fab-mini info consultar_logs_asimilados" data-usuario="' + d.id_usuario + '" value="' + d.id_pago_i + '" style="margin-right: 3px"><i class="material-icons">info</i></button>';
                        } else {
                        ...
                        switch (d.forma_pago) {
                            ...
                            //         return '<button class="btn btn-round btn-fab btn-fab-mini info consultar_logs_facturas2" data-usuario="' + d.id_usuario + '" value="' + d.id_pago_i + '" style="margin-right: 3px"><i class="material-icons">info</i></button>' +
                            //             '<button disabled  class="btn btn-secondary btn-round btn-fab btn-fab-mini subir_factura" title="YA TIENE UNA FACTURA" value="' + d.id_pago_i + '" style="margin-right: 3px;color:#fff;"><i class="material-icons">publish</i></button>' +
                            //             '<button class="btn btn-danger btn-round btn-fab btn-fab-mini quitar_factura" title="ELIMINAR FACTURA" value="' + d.id_pago_i + '" style="margin-right: 3px;color:#fff;"><i class="material-icons">close</i></button>';

                            //     } else {
                            //         return '<button class="btn btn-round btn-fab btn-fab-mini info consultar_logs_asimilados" data-usuario="' + d.id_usuario + '" value="' + d.id_pago_i + '" style="margin-right: 3px"><i class="material-icons">info</i></button>' +
                            //             '<button class="btn btn-info btn-round btn-fab btn-fab-mini subir_factura" title="SUBIR FACTURA" data-total="'+d.pago_cliente+'" value="' + d.id_pago_i + '" style="margin-right: 3px;color:#fff;"><i class="material-icons">publish</i></button>';
           ...
           exportOptions: {
            ...
            "columns": [
...

                {
                    ...
                    "orderable": false,
                    "data": function(d) {
                        if(d.estado_fecha=='ESTA SEMANA'){
                            return '<p style="font-size: .8em"><span class="label" style="background:#549EF3;">' + d.estado_fecha + '</span></p>';
                        }
                        else{
                ...
                },
                {
                    "width": "8%",
                    "data": function(d) {
                         return '<button class="btn btn-round btn-fab btn-fab-mini info consultar_logs_revision" data-usuario="' + d.id_usuario + '" value="' + d.id_pago_i + '" style="margin-right: 3px"><i class="material-icons">info</i></button>';
                    }
                }
            ],
            ...
            "ajax": {
                "url": url2 + "Comisiones/getDatosComisionesRevision",
    ...
    $("#tabla_revision_comisiones tbody").on("click", ".consultar_logs_asimilados", function(){
          id_pago = $(this).val();
          user = $(this).attr("data-usuario");
           ...
           exportOptions: {
            ...
            "columns": [
...

                {
                    "width": "8%",
                    "data": function(d) {
                         return '<button class="btn btn-round btn-fab btn-fab-mini info consultar_logs_pagar" data-usuario="' + d.id_usuario + '" value="' + d.id_pago_i + '" style="margin-right: 3px"><i class="material-icons">info</i></button>';
                    }
                }
            ...
            "ajax": {
                "url": url2 + "Comisiones/getDatosComisionesPorPagar",
                /*registroCliente/getregistrosClientes*/
                "type": "POST",
                cache: false,
                "data": function(d) {}
    ...
    $("#tabla_pagadas_comisiones tbody").on("click", ".consultar_logs_asimilados", function(){
          id_pago = $(this).val();
          user = $(this).attr("data-usuario");
    ...
    $("#tabla_otras_comisiones").ready(function() {
        ...
        tabla_otras = $("#tabla_otras_comisiones").DataTable({
           ...
           exportOptions: {
            ...
            "columns": [
...

                {
                    ...
                    "data": function(d) {
                        ...
                        var validate_st;
                        return validate_st = (d.pci == 0) ? '<p style="font-size: .8em"><span class="label" style="background:#D5B226;">SIN PAGO EN NEODATA</span></p>' : '<p style="font-size: .8em"><span class="label" style="background:#4BCBCC;"> PAUSADA </span></p>';
                        // return '<p style="font-size: .8em">'+d.estado_fecha+'</p>';
            ...
            "ajax": {
                "url": url2 + "Comisiones/getDatosComisionesOtras",
                /*registroCliente/getregistrosClientes*/
                "type": "POST",
                cache: false,
                "data": function(d) {}
    ...
    $("#tabla_otras_comisiones tbody").on("click", ".consultar_logs_asimilados", function(){
          id_pago = $(this).val();
          user = $(this).attr("data-usuario");
       ...
       function fillCommissionTableWithoutPayment (proyecto, condominio) {
        tabla_comisiones_sin_pago = $("#tabla_comisiones_sin_pago").DataTable({
            ...
            columns: [
                ...
                {
                    data: function(d) {
                        return '<p style="font-size: .8em">' + d.nombreCliente + ' </p>';
                    }
                },

                {
                    data: function(d) {
                        return '<p style="font-size: .8em">' + d.nombreAsesor + '</p>';
                    }
                },
                {
                    data: function(d) {
                        return '<p style="font-size: .8em">' + d.nombreCoordinador + '</p>';
                    }
                },
                {
                    data: function(d) {
                        return '<p style="font-size: .8em">' + d.nombreGerente + '</p>';
                    }
                },
                {
                    data: function(d) {
                        ...
                        if(d.reason == 0){
                            return '<p style="font-size: .8em"> Sin saldo aplicado.</p>';
                        }else if(d.reason == 2){
                            return '<p style="font-size: .8em">No se encontró referencia en Neodata.</p>';
                        }
                        else if(d.reason == 3){
                            return '<p style="font-size: .8em">No tiene vivienda, si hay referencia.</p>';

                        }
                        else if(d.reason == 4){
                            return '<p style="font-size: .8em">No hay pagos aplicados a esta referencia.</p>';

                        }
                        else if(d.reason == 5){
                            return '<p style="font-size: .8em">Referencia duplicada.</p>';
...
//console.log(pagos);
    ...
    $(document).on("click", ".quitar_factura", function() {
        ...
        // $("#modalQuitarFactura").append( {backdrop: 'static', keyboard: false} );
            ...
            $.getJSON(url + "Comisiones/getDatosProyecto/" + valorSeleccionado).done(function(data) {
                ...
                if (!data) {
                    ...
                    $.each(data, function(i, v) {
                        ...
                        $("#modal_multiples .modal-body").append('<div class="row"><div class="col-md-1"><input type="checkbox" class="form-control data1 ng-invalid ng-invalid-required" id="comisiones_facura_mult' + i + '" name="comisiones_facura_mult"></div><div class="col-md-4"><input id="data1' + i + '" name="data1' + i + '" value="' + v.nombreLote + '" class="form-control data1 ng-invalid ng-invalid-required" required placeholder="%"></div><div class="col-md-4"><input type="hidden" id="idpago-' + i + '" name="idpago-' + i + '" value="' + v.id_pago_i + '"><input id="data2' + i + '" name="data2' + i + '" value="' + "" + abono_asesor + '" class="form-control data1 ng-invalid ng-invalid-required" readonly="" required placeholder="%"></div></div>');
                        //subir_xml += v.abono_neodata.toFixed(2);
                    });
                    ...
                    $("#modal_multiples .modal-body").append('<form id="frmnewsol2" method="post">' +
                        ...
                        '<div class="col-lg-4 form-group"><label for="rfcemisor">RFC Emisor:<span class="text-danger">*</span></label><input type="text" class="form-control" id="rfcemisor" name="rfcemisor" placeholder="RFC Emisor" value="" required></div><div class="col-lg-8 form-group"><label for="receptor">Receptor:<span class="text-danger">*</span></label><input type="text" class="form-control" id="receptor" name="receptor" placeholder="Receptor" value="" required></div>' +
                        '<div class="col-lg-4 form-group"><label for="rfcreceptor">RFC Receptor:<span class="text-danger">*</span></label><input type="text" class="form-control" id="rfcreceptor" name="rfcreceptor" placeholder="RFC Receptor" value="" required></div>' +
...
console.log(cantidadXml);

let pago1 = parseFloat(pago_cliente) + .10;
let pago2 = parseFloat(pago_cliente ) - .10;
console.log(pago1);
  ...
  if (parseFloat(pago1).toFixed(2) >= cantidadXml.toFixed(2) && cantidadXml.toFixed(2) >= parseFloat(pago2).toFixed(2)) {
           ...
           // let myCommentsList = document.getElementById('cantidadSeleccionadaMal2');
    ...
    function cargar_info_xml2(informacion_factura) {
        ...
        for (let index = 0; index < c; index++) {
            if (document.getElementById("comisiones_facura_mult" + index).checked == true) {
                ...
                //var porNombre=document.getElementsByName("comisiones_facura_mult").val();
                //console.log($("#data2"+index).val());
                cantidad = Number.parseFloat($("#data2" + index).val());
                // cantidad = parseFloat($("#data2"+index).val());
                suma += cantidad;
        ...
        myCommentsList.innerHTML = 'Cantidad seleccionada: $ ' + suma;
        let cantidadXml = Number.parseFloat(informacion_factura.total[0]);
        ...
        //console.log(cantidadXml.toFixed(2) );
        //console.log((suma + .11).toFixed(2) );
    ...
    function save2() {
        ...
        //console.log(pagos);
        $.ajax({
            url: url + 'Comisiones/guardar_solicitud2/' + pagos,
            data: formData,
            cache: false,
            contentType: false,
            processData: false,

    ...
    <script>
        ...
        function getFacturaCommissions(proyecto, condominio){
                ...
                },
                {
                    ...
                    "data": function( d ){
                        if(d.estatus == 11 || d.estatus == '11' || d.estatus == 17 || d.estatus == '17'){
                            return '<span class="label label-info">APLICADO</span>';    
                        }
                        else if(d.estatus == 16 || d.estatus == '16'){
                            return '<span class="label label-warning">DESCUENTO PAGO SOLICITADO</span>'; 
                        }
                        else{
            ...
            /*$("#tabla_factura tbody").on("click", ".cambiar_estatus", function(){
                ...
                $("#modal_nuevas .modal-body").append('<div class="row"><div class="col-lg-12"><input type="text" class="form-control observaciones" name="observaciones" required placeholder="Describe motivo por el cual se pausó la solicitud"></input></div></div>');
            ...
            /*$("#tabla_factura tbody").on("click", ".despausar_estatus", function(){
                var tr = $(this).closest('tr');
                var row = tabla_factura2.row( tr );
                id_pago_i = $(this).val();
            ...
            /*$("#tabla_factura tbody").on("click", ".consultar_documentos", function(){
                id_com = $(this).val();
                ...
                $.getJSON( url + "Comisiones/getDatosFactura/"+id_com).done( function( data ){
                    ...
                    if (!data.datos_solicitud['id_factura'] == '' && !data.datos_solicitud['id_factura'] == '0'){
                        ...
                        $("#seeInformationModal .facturaInfo").append('<div class="col-md-12"><label style="font-size:10px; margin:0; color:orange;">NO HAY DATOS A MOSTRAR</label></div>');
                    }
            ...
            submitHandler: function( form ) {
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if( data[0] ){
                            $("#modal_nuevas").modal('toggle' );
                            alerts.showNotification("top", "right", "Se pausó la comisión exitosamente", "success");
                            setTimeout(function() {
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if( data[0] ){
                            ...
                            alerts.showNotification("top", "right", "Se regresó la comisión exitosamente", "success");
                            setTimeout(function() {
                                tabla_factura2.ajax.reload();
                                // tabla_otras2.ajax.reload();
                            }, 3000);

    ...
    <script>
        ...
        $("#tabla_bono_revision").ready(function() {
            ...
            tabla_nuevas = $("#tabla_bono_revision").DataTable({
                    ...
                    action: function(){
                        if ($('input[name="idTQ[]"]:checked').length > 0 ) {
                            ...
                            $.get(url+"Comisiones/enviarBonosMex/"+idbono).done(function () {
                                ...
                                $("#myModalEnviadas .modal-body").append("<center><img style='width: 25%; height: 25%;' src='<?= base_url('dist/img/mktd.png')?>'><br><br><b><P style='color:#BCBCBC;'>"+mensaje+"</P></P></b></center>");
                            });
                        }
                    },
                    attr: {
                ...
                ajax: {
                    url: url2 + "Comisiones/getBonosPorUserContra/" + estatus,
                    type: "POST",
                    cache: false,
                    data: function(d) {
                    }

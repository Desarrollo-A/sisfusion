                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group label-floating select-is-empty">
                                                ...
                                                <select name="mes" id="mes"
                                                        ...
                                                        title="Selecciona un mes" data-size="7" required>
                                                    <?php
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group label-floating select-is-empty">
                                                ...
                                                <select name="anio" id="anio"
                                                        ...
                                                        data-style="btn" data-show-subtext="true"
                                                        data-live-search="true"
                                                        title="Selecciona un año" data-size="7" required>
                                                    <?php
                                                    setlocale(LC_ALL, 'es_ES');
    ...
    <script>
        ...
        function getAssimilatedCommissions(mes, anio) {
            ...
            tabla_historialGral2 = $("#tabla_historialGral").DataTable({
                ...
                "columns": [
...

                    {
                        ...
                        "data": function(d) {
                            ...
                            if(d.totalNeto2 < 1 && d.precio == null){
                                precio = d.totalNeto2;
                                return '<p style="font-size: .8em">$' + formatMoney(precio) + '</p>';
...

                    {
                        ...
                        "data": function(d) {
                            ...
                            if(d.idc_mktd != null)
                            {
                                compar = '<span class="label label-info">COMPARTIDA</span><br>'+'<p style="font-size: .8em"><b>' +d.sd1+' / '+d.sd2+ '</b></p>';
                            }
                            if (d.status == 0 || d.status == '0'){
                                return '<p style="font-size: .8em; color: red;"><b>CANCELADO</b></p><center>'+compar+'<center>';
                            }
                            else{
                                return '<p style="font-size: .8em"><b>' + (d.estatus).toUpperCase() + '</b></p><center>'+compar+'<center>';
                            }
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "data": function(d) {
                            if(d.idStatusContratacion>8){
                                return '<p style="font-size: .8em">$' + formatMoney(d.comision_total-d.abono_pagado) + '</p>';
                            }
                            else{
                                return '<p style="font-size: .8em"> - </p>';
                            }
                    ...
                    },
                    {
                        ...
                        "data": function(d) {
                            ...
                            switch(d.bandera){
                                case 7:
                                case '7':
                                $label = '<p style="font-size: .8em;"><b>LIQUIDADA</b></p>';
                                break;
                                ...
                                case 0:
                                case '0':
                                $label = '<p style="font-size: .8em; color: green;"><b>ACTIVA</b></p>';
                                break;

                                default:
                                $label = '<p style="font-size: .8em; color: blue;"><b>SIN DISPERSAR</b></p>';
                                break;
                            }
                ...
                "ajax": {
                    "url": "<?=base_url()?>index.php/Comisiones/getDatosCobranzaRanking/" + mes + "/" + anio,
                    "dataSrc": "",
                    "type": "POST",
                    cache: false,
                    "data": function( d ){

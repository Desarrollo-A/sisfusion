...
<body>
    ...
    <script>
        ...
        $('#filtro33').change(function(ruta){
            ...
            $.ajax({
                url: '<?=base_url()?>Comisiones/lista_usuarios/'+residencial+"/"+4,
                type: 'post',
                dataType: 'json',
        ...
        $(document).on("click", ".Pagar", function() {            
            ...
            $.post('getDesarrolloSelectINTMEX/'+4, function(data) {
            ...
            $('#desarrolloSelect').change(function() {
                ...
                $.getJSON(url + "Comisiones/getPagosByProyect/"+valorSeleccionado+"/"+4).done(function(data) {
                    let sumaComision = 0;
                    console.log(data[0]);
                    if (!data) {

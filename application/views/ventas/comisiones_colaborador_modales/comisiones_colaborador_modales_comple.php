    ...
    <div class="modal-dialog">
        <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="exampleModalLabel1"><b>información Excedente </b></h5>     
                </div>
                <div class="modal-body">
                    <div class="col-lg-6 col-md-6 text-center">
                    <i style="color:#0a548b; " class="fas fa-compass"></i>
                        <br><b>Origen. </b>
                        <p id="origenes" name="origenes">El valor que ingreses .</p>
                    </div>
                    <div class="col-lg-6 col-md-6 text-center">
                    <i class="fas fa-plane-departure"></i>
                        <br><b>Destino. </b>
                        <p id="destino" name="destino">El valor que ingreses .</p>
                    </div>
                    ...
                    <i class="fas fa-ruler"></i>
                        <br><b>Excedente superficie. </b>
                        <p id="exceSup" name="exceSup">El valor que ingreses .</p>
                    </div>
                    <div class="col-lg-6 col-md-6 text-center">
                    <i class="fas fa-coins"></i>
                        <br><b>Monto Excedente. </b>
                        <p id="exceMonto" name="exceMonto">El valor que ingreses .</p>
                    </div>
                    <div class="col-lg-12 col-md-12 text-center"></div>
                    ...
                    <i class="fas fa-calculator"></i>
                        <br><b>1% de origen. </b>
                        <p id="ExcedenteDinero" name="ExcedenteDinero">El valor que ingreses .</p>
                    </div>
                    <div class="col-lg-6 col-md-6 text-center">
                    <i class="fas fa-money-bill-wave"></i>
                        <br><b>$.5 del excedente. </b>
                        <p id="porciento1" name="porciento1">El valor que ingreses .</p>
                    </div>
                </div>

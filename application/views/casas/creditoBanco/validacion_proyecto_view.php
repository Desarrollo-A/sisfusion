...
<body class="">
                    ...
                    <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="toolbar">
                                    <h3 class="card-title center-align">Paso 7 - Validación de proyectos</h3>
    ...
    <script src="<?= base_url() ?>dist/js/controllers/casas/creditoBanco/validacion_proyecto.js?=v1"></script>
</body>
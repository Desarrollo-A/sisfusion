...
<body class="">
                    ...
                    <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="toolbar">
                                    <h3 class="card-title center-align">Paso 17 - Recepción de contrato</h3>
    ...
    <script src="<?= base_url() ?>dist/js/controllers/casas/creditoBanco/recepcion_contrato.js"></script>
</body>
...
<?php $this->load->view('cobranza/comisionista/complemento/reporte_lotes_x_comisionista_comple'); ?>
<body>
    ...
    <script src="<?= base_url() ?>dist/js/controllers/cobranza/comisionista/reporte_lote_x_comisionista.js"></script>

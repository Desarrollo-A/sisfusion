				...
				<div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="card">
						...
						<div class="card-content">
							<h4 class="card-title">Contratos clientes</h4>
							<div class="toolbar">
				...
				"columns":
					[
						...
						},
						{
							...
							{
								var myLinkConst;
								if(data.contratoArchivo == null || data.contratoArchivo == '' || data.contratoArchivo == NULL)
								{
									myLinkConst = '<i>Sin contrato</i>';
								}
								else
								{
									myLinkConst = '<p>'+data.contratoArchivo +'</p>';
								}
								return myLinkConst;
							}
						},
						{
							...
							render: function(data, type, row)
							{
								...
								else
								{
									...
									myLinkConst = '<a type="button" data-toggle="modal" data-target="#fileViewer"><span class="material-icons" style="cursor: pointer">attach_file</span></a>'
								}

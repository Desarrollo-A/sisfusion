...
<div class="wrapper ">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title"><label>Registro estatus 7 (Ventas)- <b><span class="lote"></span></b></label></h4>
                </div>
                <div class="modal-body">
                    <label>Comentario</label>
    ...
    <div class="modal fade" id="rechazoAs" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h4 class="modal-title"><label>Rechazo estatus 7 (Asesor)- <b><span class="lote"></span></b></label></h4>
                </div>
                <div class="modal-body">
                    <label>Comentario</label>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12 overflow-hidden">
                            ...
                            <select name="user_re" id="user_re" class="selectpicker select-gral m-0" data-style="btn" data-live-search="true" title="SELECCIONA UN USUARIO" data-size="7"  data-container="body" required></select>
                        </div>
                    </div>
                </div>
                <div class="modal-footer"></div>
...
<script src="<?= base_url() ?>dist/js/controllers/juridico/datos_status7Contratacion_juridico.js"></script>

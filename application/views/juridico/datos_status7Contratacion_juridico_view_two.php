                ...
                },
                {
                    ...
                    "data": function (data) {
                        ...
                        if (data.vl == '1') {
                            ...
                            if (user == 2762 || user == 6096 || user == 6864 || user == 10937 || user == 10938 || user == 12136) {
                            ...
                            if ((data.ubicacion == 1 || data.ubicacion == 2 || data.ubicacion == 4 || data.ubicacion == 5 || data.ubicacion == 3) && (data.user == 2762 || data.user == 2845 || data.user == 2747 || user == 6096 || user == 6864 || user == 10937 || user == 10938 || user == 12136)) {

        ...
        <div class="modal-content">
            ...
            <div class="modal-body d-flex justify-center">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6" >
                        <label class="d-flex justify-center pb-2" for="id_sede">ESTADO(<span class="text-danger">*</span>)</label>
                        <select class="selectpicker select-gral" name="id_sede" id="id_sede" data-style="btn" data-show-subtext="true" title="SELECCIONA UNA OPCIÓN" data-size="7" data-container="body" required></select>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <label class="d-flex justify-center pt-2">HORA INICIAL(<span class="text-danger">*</span>)</label>
                        <input type="text" class="form-control input-gral mt-3" id="hora_inicio" name="hora_inicio" required>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <label class="d-flex justify-center pt-2">HORA FINAL(<span class="text-danger">*</span>)</label>
                        <input type="text" class="form-control input-gral mt-3" id="hora_fin" name="hora_fin" required>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body d-flex justify-center">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <label class="d-flex justify-center">DIRECCION(<span class="text-danger">*</span>)</label>
                        <input type="text" class="form-control input-gral mt-3" id="direccionM" name="direccionM" required>                    
                    </div>
                        <input type="hidden" name="id_direccion" id="id_direccion">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <label class="d-flex justify-center pb-2" for="id_sedeEdit">ESTADO(<span class="text-danger">*</span>)</label>
                        <select class="selectpicker select-gral" name="id_sedeEdit" id="id_sedeEdit" data-style="btn" data-show-subtext="true" title="SELECCIONA UNA OPCIÓN" data-size="7" data-container="body" required></select>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <label class="d-flex justify-center pt-2">HORA INICIAL(<span class="text-danger">*</span>)</label>
                        <input type="text" class="form-control input-gral mt-3" id="hora_inicioM" name="hora_inicio" required>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <label class="d-flex justify-center pt-2">HORA FINAL(<span class="text-danger">*</span>)</label>
                        <input type="text" class="form-control input-gral mt-3" id="hora_finM" name="hora_fin" required>
                    </div>

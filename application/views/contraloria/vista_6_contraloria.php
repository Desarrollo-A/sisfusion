				...
				<div class="modal-body">
					<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col col-xs-12 col-sm-12 col-md-6 col-lg-12">
                            ...
                            <input class="form-control input-gral" name="totalNeto" id="totalNeto" oncopy="return false"
			...
			<div class="modal-content" >
				...
				<div class="modal-body">
					<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col col-xs-12 col-sm-12 col-md-6 col-lg-12">
                            <label id="tvLbl">Enganche:</label>
                            <input class="form-control input-gral" name="totalNeto" id="totalNetoR" oncopy="return false"
                                   onpaste="return false" onkeypress="return SoloNumeros(event)" type="tel" pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" >
                        </div>
					</div>
				</div>
			...
			<div class="modal-content" >
				...
				<div class="modal-body">
					<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col col-xs-12 col-sm-12 col-md-6 col-lg-12">
                            <label id="tvLbl">Enganche:</label>
                            <input class="form-control input-gral" name="totalNeto" id="totalNetoRevA7" oncopy="return false"
                                   onpaste="return false" onkeypress="return SoloNumeros(event)" type="tel" pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" >
                        </div>
					</div>
				</div>
			...
			<div class="modal-content" >
				...
				<div class="modal-body">
					<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col col-xs-12 col-sm-12 col-md-6 col-lg-12">
                            <label id="tvLbl">Enganche:</label>
                            <input class="form-control input-gral" name="totalNeto" id="totalReturn1" oncopy="return false"
                                   onpaste="return false" onkeypress="return SoloNumeros(event)" type="tel" pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" >
                        </div>
					</div>
				</div>

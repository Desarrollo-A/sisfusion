                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4 col-md-4 col-lg-12">
                                        <div id="enganche" style="display:none">
                                            ...
                                            <input type="text" id="enganches" name="enganches" class="form-control input-gral" style="text-align:center" value="" onkeyup="format(this)" onchange="format(this)">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4 col-md-4 col-lg-12">
                    ...
                    <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <p class="card-title center-align">En esta vista podrás hacer la actualización del precio total con descuentos, enganche y ubicación de un lote apartado.</p>
                                <div  class="toolbar">
                                    <div class="row">

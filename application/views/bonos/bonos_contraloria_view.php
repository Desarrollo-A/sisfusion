                            ...
                            <div class="toolbar">
                                <div class="container-fluid p-0">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-md-12 mb-12" style="padding-top:35px;  margin-bottom:2px">
                                            <div class=" shadow  py-2">
                                                    <div class=" no-gutters align-items-center">
                                                        <div class="col mr-12">
                                                                <h4 class="title-tot center-align m-0">Total bonos aplicados:</h4>
                                                            <div class="center-align"  >
                                                            <p class="card-title pl-1"  style=" padding-top:20px;">(Bonos con pagos pendientes, una vez liquidados podrás consultarlos en el Historial de bonos)</p>
                                                            <i class="fas fa-coins fa-2x " style=" color: #0067d4;" ></i>
                                                            </div>
                                                            <div  name="totalp" id="totalp"
                                                                class="h5 totalp mb-0 font-weight-bold text-gray-800 center-align">$0.00
                                                            </div>
                                                        </div>            
                                                    </div>
                                            </div>
...
<script src="<?= base_url() ?>dist/js/controllers/bonos/bonos_contraloria.js"></script>
</body>
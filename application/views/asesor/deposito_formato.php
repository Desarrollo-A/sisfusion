                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        <div class="form-group label-floating">
                            ...
                            <input class="form-control input-gral" minlength="2" name="costom2f" id="costom2f" oninput="this.value = formatearNumero(this.value)"  <?php echo $readOnly; ?> step="any" required value="<?=$cliente[0]->costom2f?>"/>
                            <div><?php echo $this->session->flashdata('costom2f'); ?></div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        <div class="form-group label-floating">

    ...
    function fillDataTable(id_condominio) {
        tabla_valores_ds = $("#tabla_deposito_seriedad").DataTable({
            ...
            columns: [
                ...
                {
                    "data": function( d ){
                        fv = (d.idMovimiento == 73 || d.idMovimiento == 92 || d.idMovimiento == 96 || d.idMovimiento == 104 || d.idMovimiento == 108 || d.idMovimiento == 109 || d.idMovimiento == 111 ) ?  d.modificado: d.fechaVenc;
                        return fv;
                    }
                },
                {

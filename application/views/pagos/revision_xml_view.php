               ...
               <div class="card-content p-0">
                   <div class="nav-tabs-custom">
                       <div class="tab-content p-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group d-flex justify-center align-center">
                                                    ...
                                                    <p class="input-tot pl-1" name="autorizarXml" id="autorizarXml">$0.00</p>
                                                </div>
                                            </div> -->
                                        </div>
                           ...
                           <div class="tab-pane" id="xmlOOAM">
                                  <div class="text-center">
                                    <h3 class="card-title center-align" >Comisiones en revisión <b>xml OOAM</b></h3>
                                    <p class="card-title pl-1">Concentrado de facturas solicitadas por el área de OOAM.</p>                                  </div>
                                  <div class="toolbar">
                                      <div class="container-fluid p-0">
                                      <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group d-flex justify-center align-center">
                                                    ...
                                                    <p class="input-tot pl-1" name="disponibleXmlOOAM" id="disponibleXmlOOAM">$0.00</p>
                                                </div>
                                            </div>
                                            <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group d-flex justify-center align-center">
                                                    <h4 class="title-tot center-align m-0">Autorizar:</h4>
                                                    <p class="input-tot pl-1" name="autorizarXmlOOAM" id="autorizarXmlOOAM">$0.00</p>
                                                </div>
                                            </div> -->
                                        </div>
                                      </div>
                                      <div class="row aligned-row d-flex align-end">
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">          
                                                <div class="form-group">
                                                    <label class="control-label" for="proyectoXmlOOAM">Proyecto</label>
                                                    <select name="proyectoXmlOOAM" id="proyectoXmlOOAM" class="selectpicker select-gral m-0" data-style="btn " data-show-subtext="true" data-live-search="true" data-container="body" title="SELECCIONA UNA OPCIÓN" data-size="7" required></select>
                                                </div>
                                            </div>
                            
                                        </div>

                                      <table class="table-striped table-hover" id="tabla_xml_ooam" name="tabla_xml_ooam">
                                        <thead>
                                            <tr>
                                                    <th></th>
                                                    <th>USUARIO</th>

...
class Elementos_Correo_Registro_Cliente
{
    ...
    * 1.- EMAIL_DEPOSITO_SERIEDAD: PARTE DEL CUERPO DEL CORREO DANDO UNA INTRODUCCIÓN DEL MISMO.                                          *
    * 2.- ETIQUETAS_ENCABEZADO_TABLA_DEPOSITOS_SERIEDAD: ETIQUETAS PARA COLOCAR LOS ENCABEZADOS DE LA TABLA QUE SE GENERA DINÁMICAMENTE    *
    **************************************************************************************************************************************/
    ...
    * 1.- EMAIL_SOLICITUD_AUTORIZACION_CONTRATACION: PARTE DEL CUERPO DEL CORREO DANDO UNA INTRODUCCIÓN DEL MISMO.                        *
    ...
    * 1.- EMAIL_SOLICITUD_ASESOR_AUTORIZACIONES: PARTE DEL CUERPO DEL CORREO DANDO UNA INTRODUCCIÓN DEL MISMO.                        *
    ...
    * 1.- EMAIL_ELIMINAR_ARCHIVO_CORRIDA: PARTE DEL CUERPO DEL CORREO DANDO UNA INTRODUCCIÓN DEL MISMO.                                   *
    * 2.- ETIQUETAS_ENCABEZADO_TABLA_ELIMINAR_ARCHIVO_CORRIDA: ETIQUETAS PARA COLOCAR LOS ENCABEZADOS DE LA TABLA QUE SE                  *
    *     GENERA DINAMICAMENTE                                                                                                            *
    **************************************************************************************************************************************/
    CONST EMAIL_ELIMINAR_ARCHIVO_CORRIDA = 'Se eliminó definitivamente el archivo (CORRIDA) del registro que se menciona a continuación.';

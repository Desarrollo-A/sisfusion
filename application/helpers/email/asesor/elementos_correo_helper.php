...
class Elementos_Correos_Asesor
{
    ...
    * 1.- EMAIL_NUEVA_AUTORIZACION_SBMT: PARTE DEL CUERPO DEL CORREO DANDO UNA INTRODUCCIÓN DEL MISMO.                                           *
    * 2.- ETIQUETAS_ENCABEZADO_TABLA_NUEVA_AUTORIZACION_SBMT: ETIQUETAS PARA COLOCAR LOS ENCABEZADOS DE LA TABLA QUE SE GENERA DINÁMICAMENTE     *
    ***************************************************************************************************************************************/
    ...
    * 1.- EMAIL_DEPOSITO_SERIEDAD_ASESOR: PARTE DEL CUERPO DEL CORREO DANDO UNA INTRODUCCIÓN DEL MISMO.                                       *
    * 2.- ETIQUETAS_ENCABEZADO_TABLA_DEPOSITOS_SERIEDAD_ASESOR: ETIQUETAS PARA COLOCAR LOS ENCABEZADOS DE LA TABLA QUE SE GENERA DINÁMICAMENTE*
    ******************************************************************************************************************************************/
    ...
    * 1.- EMAIL_EVIDENCIAS_RECHAZADAS_ASESOR: PARTE DEL CUERPO DEL CORREO DANDO UNA INTRODUCCIÓN DEL MISMO.                                       *
    * 2.- ETIQUETAS_ENCABEZADO_TABLA_EVIDENCIAS_RECHAZADAS_ASESOR: ETIQUETAS PARA COLOCAR LOS ENCABEZADOS DE LA TABLA QUE SE GENERA DINÁMICAMENTE*
    ******************************************************************************************************************************************/

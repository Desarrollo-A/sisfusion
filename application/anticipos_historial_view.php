                        ...
                        <div class="modal-body">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group m-0 overflow-hidden">
                                    ...
                                    <select class="selectpicker select-gral m-0" name="procesoAntInternomex" id="procesoAntInternomex" data-style="btn" data-show-subtext="true"  title="" data-size="7" data-live-search="true" data-container="body" required>

...
*/
        $dataInsertCliente = array(
            ...
            'id_sede' => $data['lider'][0]['id_sede'], //$data['prospecto'][0]['id_sede'],
...
public function getProspectInformationByReference() {
    ...
    public function updateCondominio()
    {
        ...
        // print_r($data->idCondominio);
        // exit;

        

        if (!isset($data->idCondominio) || !isset($data->nombre) || !isset($data->nombre_condominio) || !isset($data->abreviatura) || !isset($data->idEtapa) || !isset($data->idDBanco) || !isset($data->idResidencial)){
            ...
            if ($data->idCondominio == "" || $data->nombre == "" || $data->nombre_condominio == "" || $data->abreviatura == "" ||

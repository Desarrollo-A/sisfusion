	...
	public function Procesos_Status($idStatus, $idMov){
		...
		$Control_Pro = array(
			...
			"ProcContra"			=>	array(
				...
				'9.Contrato recibido confirma de cliente (Contraloría)',
				'10.Solicitud de validación de enganche y envio de contratoaRL (Contraloría)',
				//'12.Contratofirmado(RepresentanteLegal)//vista8y11',
				'13.Contrato listo y entregado asesores (Contraloría)',
				'14.Firma Acuse cliente (AsistentesGerentes)',

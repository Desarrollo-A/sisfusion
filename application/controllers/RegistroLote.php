	...
	public function editar_registro_lote_caja()
	{
		...
		if ($idStatusLote == 9 || $idStatusLote == 10) {
            ...
            ********************************************************************************/
			...
			$elementos_correo = array("setFrom" => Elementos_Correo_Registro_Lote::SET_FROM_EMAIL,
...
///////////////////// FIN PANEL PARA REGISTRAR EL STATUS POR AREA/////////////////////////////////////////////7
	...
	public function Procesos_Status($idStatus, $idMov){
		...
		$Control_Pro = array(
			...
			"ProcContra"			=>	array(
				'2. Recepción de Expediente<br>(ventas-asesor)',
				'2. Integración de Expediente<br>(Contraloría)',
				'3. Revisión Jurídico<br>(Jurídico)',
				'4. Datos Verificados<br>(Postventa)',
				'5.Revisión 100%<br>(Contraloria)',
				'6.Corrida elaborada<br>(Contraloría)',
				'7.Contrato elaborado<br>(Jurídico)',
				'7.Elaboración de Contrato<br>(Jurídico)',
				'9.Contrato recibido confirma de cliente<br>(Contraloría)',
				'10.Solicitud de validación de enganche<br>y envio de contratoaRL (Contraloría)',
				//'12.Contratofirmado(RepresentanteLegal)//vista8y11',
				'13.Contrato listo y<br>entregado asesores (Contraloría)',
				'14.Firma Acuse cliente<br>(AsistentesGerentes)',
				'15.Acuse entregado<br>(Contraloría)',
				'LOTE CONTRATADO',
				'8. Contrato entregado al asesor para firma del cliente (Asistentes de Gerentes) <br> 11. Validación de enganche (Administración)',
				'8.Contrato entregado al asesor<br>para firma del cliente (AsistentesdeGerentes)',
				'11.Validación de enganche<br>(Administración)')
		);

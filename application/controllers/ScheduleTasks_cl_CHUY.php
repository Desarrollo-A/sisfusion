<?php class ScheduleTasks_cl_CHUY extends CI_Controller {
...
public function select_gph_maderas_649(){ //HACER INSERT DE LOS LOTES EN 0 Y PASARLOS A 1

  $QUERY_DATA_GPHSIS = $this->gphsis->query("SELECT * FROM [GPHSIS].[dbo].[Comisiones] WHERE Saldorestante IS NOT NULL AND Montoultimoabono IS NOT NULL AND Marca = 1 AND USR IS NOT NULL AND USR NOT IN (0) AND Referencia NOT IN (0,  1140094,  1150622,  5001029,  8020331)  and Referencia = 8160491");

					...
					[
						...
						{data: 'modificado'},
						{
							...
							render: function ( data, type, row )
							{
								...
								if (getFileExtension(data.expediente) == "pdf") {
									if(data.tipo_doc == 8){
										if(data.idMovimiento == 36 || data.idMovimiento == 6 || data.idMovimiento == 23 || data.idMovimiento == 76 || data.idMovimiento == 83){
											file = '<a class="pdfLink3" data-Pdf="'+data.expediente+'" title= "Ver archivo" style="cursor:pointer;" data-nomExp="'+data.expediente+'"><img src=\'<?=base_url()?>static/images/pdf.png\' style="width:50%"/></a> | <button type="button" title= "Eliminar archivo" id="deleteDoc" class="btn btn-danger delete" data-tipodoc="'+data.movimiento+'" data-iddoc="'+data.idDocumento+'" ><span class="glyphicon glyphicon-trash"></span></i></button>';
										} else {
									...
									if(data.tipo_doc == 7){
										file = '<button type="button" title= "Corrida inhabilitada" class="btn btn-warning disabled"><i class="fa fa-list-alt" aria-hidden="true"></i></button>';
								...
								{
									file = '<a class="pdfLink" data-Pdf="'+data.expediente+'" data-nomExp="'+data.expediente+'"><img src="<?=base_url()?>static/documentos/cliente/expediente/'+data.expediente+'" style="cursor:pointer;" style="cursor:pointer;width:50%"/></a>';
								}
								return file;
							}
						},

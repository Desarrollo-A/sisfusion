  ...
  if($this->session->userdata('id_rol')=="18")//contraloria
    {
     ...
     else if($this->session->userdata('id_rol')=="1" ||  $this->session->userdata('id_rol')=="3" ||$this->session->userdata('id_rol')=="9")//contraloria
    {
     ...
     else if($this->session->userdata('id_rol')=="2")//contraloria
    {
     ...
     else if($this->session->userdata('id_rol')=="22" || $this->session->userdata('id_rol')=="23")//contraloria
    {
     ...
     else if($this->session->userdata('id_rol')=="13")//contraloria
    {        
            ...
            <div class="modal-body">
                <div class="tab-content">
                     <div class="active tab-pane" id="generar_solicitud">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="col-lg-12"><center><legend><b>CARGAR DOCUMENTO XML</b></legend></center></div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <center>
                                        <!-- <button class="btn btn-warning"><i class="fa fa-upload"></i> CARGAR</button> -->
                                                                                ...
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th style="font-size: .9em;">CONDOMINIO</th>
                                                                                         <th style="font-size: .9em;">LOTE</th>
                                                                                        <th style="font-size: .9em;">PRECIO LOTE</th>
                                                                                        <th style="font-size: .9em;">ABONO NEODATA</th>
        ...
        tabla_nuevas = $("#tabla_nuevas_comisiones").DataTable({
            ...
            "buttons": [
            {
                ...
                action: function(){
                    ...
                    if ($('input[name="idT[]"]:checked').length > 0) {
                        ...
                        $.get(url+"Comisiones/acepto_comisiones/"+idcomision).done(function () {

                            var fecha = new Date();
                            // alert(fecha.getHours()+' - '+fecha.getDay());

                            if(fecha.getHours()>=16 && fecha.getDay()==3){//miercoles 3 fecha.getHours()>=10 && f
            ...
            },
            {
            ...
            },
             {
                "width": "10%",
                "data": function( d ){
                    return '<p style="font-size: .8em">$'+formatMoney(d.porcentaje_dinero)+'</p>';
                }
            },
            {
                "width": "8%",
...

            {
                "width": "8%",
                "data": function( d ){
                    return '<p style="font-size: .8em"><b>$ '+formatMoney(d.lugar_prosp)+'</b></p>';
                }
            },
            {
                "width": "8%",
                "data": function( d ){
                    ...
                    switch(d.forma_pago){
                        ...
                        case 2://FACTURA
                            if(d.factura != null && d.factura != 0 && d.factura != ''){
                                // return '<p style="font-size: .8em"><span class="label" style="background:#CC4B4B;">REQUIERE FACTURA</span></p>';
                                 return '<p style="font-size: .8em"><span class="label" style="background:#00B397;">LISTA PAR0A APROBAR</span></p>';
                            }else{
                                return '<p style="font-size: .8em"><span class="label" style="background:#CC4B4B;">REQUIERE FACTURA</span></p>';
                            }
                        break;
                        ...
                        case 3://ASIMILADOS
                        // return '<p style="font-size: .8em"><span class="label" style="background:#CC4B4B;">FALTAN DOCUMENTOS</span></p>';
                        return '<p style="font-size: .8em"><span class="label" style="background:#4B94CC;">ASIMILADOS</span></p><p style="font-size: .8em"><span class="label" style="background:#00B397;">LISTA PAR0A APROBAR</span></p>';
                     ...
                     switch(d.forma_pago){
                        ...
                        case 2://FACTURA
                            if(d.factura != null && d.factura != 0 && d.factura != ''){
                                ...
                                // return '<p style="font-size: .8em"><span class="label label-success">LISTA PAR0A APROBAR</span></p>';
                            }else{
                                return '<button class="btn btn-round btn-fab btn-fab-mini info consultar_documentos" data-personalidad="' + d.personalidad_juridica +'" value="' + d.id_comision +'" style="margin-right: 3px"><i class="material-icons">info</i></button>'+
                     ...
                     switch(full.forma_pago){
                        ...
                        case 2://FACTURA
                            if(full.factura != null && full.factura != 0 && full.factura != ''){
                                return '<input type="checkbox" name="idT[]" style="width:20px;height:20px;"  value="' + full.id_comision + '">';
                            }else{
                                return '';
                            }
                        break;
    ...
    document.getElementById("myText_proceso").value = to;
        ...
        tabla_revision = $("#tabla_revision_comisiones").DataTable({
            ...
            },
            {
                "width": "10%",
                "data": function( d ){
                    return '<p style="font-size: .8em"><span class="label label-success">'+d.estado_fecha+'</span></p>';
                }
            },
            {
                "width": "12%",

		...
		var table = $('#Jtabla').dataTable( {
			...
			columns: [

				{
					...
					data:function(d)
					{
						return myFunctions.validateEmptyField(d.gerente);
					}
				},
				{ data: "asesor" },
				{
				...
				},
				{
					...
					data:function(d)
					{
						return myFunctions.validateEmptyField(d.telefono);
					}
				},
				{
					// data: "usuario"
					data:function(d)
					{
						return myFunctions.validateEmptyField(d.rfc);
					}
				},
				{ data: "usuario" },
				{
					data: function( d ){
						return (d.tiene_hijos >= 1 ? '<i class="fa fa-check" aria-hidden="true" style="color:#337ab7"></i>' : "N/A");
					}
				},
				{ data: "ubicacion" },
				{

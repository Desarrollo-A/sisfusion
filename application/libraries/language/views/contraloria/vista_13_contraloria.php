                ...
                <div class="col xol-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <h4 class="card-title center-align">Registro estatus 13 (Contrato listo y entregado asesores)</h4>
                            <div class="toolbar">
                             </div>
                            <div class="material-datatables"> 
                                ...
                                <div class="form-group">
									...
									<table class="table table-responsive table-bordered table-striped table-hover" id="tabla_ingresar_13" name="tabla_ingresar_13" style="text-align:center;">
...
<!-- modal -->
	...
	<div class="modal fade" id="showMessageStats" data-backdrop="static" data-keyboard="false">
		<div class="modal-dialog modal-lg">
			<div class="modal-content" >
				<div class="modal-header">
					<h4 class="modal-title"><center><b>¡IMPORTANTE!</b></center></h4>
				</div>
				<div class="modal-body">
				</div>
				<div class="modal-footer">
				<button type="button" class="btn btn-success" data-dismiss="modal"><span class="material-icons" >done_outline</span> </i> Aceptar</button>
				</div>
			</div>
		</div>
	</div>
...
if(data.idStatusContratacion == 12 && data.idMovimiento == 42 && data.perfil == 'contraloria' && data.firmaRL == 'FIRMADO' && data.validacionEnganche == 'VALIDADO')
{
...
else if(data.idStatusContratacion == 11 && data.idMovimiento == 41 && data.perfil == 'administracion' && data.firmaRL == 'FIRMADO' && data.validacionEnganche == 'VALIDADO')
{
		cntActions = '<button href="#" data-idLote="'+data.idLote+'" data-nomLote="'+data.nombreLote+'" data-idCond="'+data.idCondominio+'"' +
		 'data-idCliente="'+data.id_cliente+'" data-fecVen="'+data.fechaVenc+'" data-ubic="'+data.ubicacion+'" data-code="'+data.cbbtton+'" ' +
		 'class="btn btn-success btn-round btn-fab btn-fab-mini editReg" title="Registrar estatus">' +
...
else if(data.idStatusContratacion == 11 && data.idMovimiento == 41 && data.perfil == 'administracion' && data.validacionEnganche == 'VALIDADO' && (data.firmaRL == 'NULL'  || data.firmaRL == null))
{
	cntActions = '<button href="#" data-idLote="'+data.idLote+'" data-nomLote="'+data.nombreLote+'" data-idCond="'+data.idCondominio+'"' +
...
else if(data.idStatusContratacion == 12 && data.idMovimiento == 42 && data.perfil == 'contraloria' && data.firmaRL == 'FIRMADO' && (data.validacionEnganche == 'NULL' || data.validacionEnganche == null))
{
	cntActions = '<button href="#" data-idLote="'+data.idLote+'" data-nomLote="'+data.nombreLote+'" data-idCond="'+data.idCondominio+'"' +
		'data-idCliente="'+data.id_cliente+'" data-fecVen="'+data.fechaVenc+'" data-ubic="'+data.ubicacion+'" ' +

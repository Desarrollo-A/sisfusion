						...
						},*/
						{
							...
							render: function ( data, type, row )
							{
								...
								if (getFileExtension(data.expediente) == "pdf") {
									if(data.tipo_doc == 8){
										file = '<a class="pdfLink3" data-Pdf="'+data.expediente+'" title= "Ver archivo" style="cursor:pointer;" data-nomExp="'+data.expediente+'"><img src=\'<?=base_url()?>static/images/pdf.png\' style="width:50%"></a>';
									} else {
										file = '<a class="pdfLink" data-Pdf="'+data.expediente+'" title= "Ver archivo" style="cursor:pointer;" data-nomExp="'+data.expediente+'"><img src=\'<?=base_url()?>static/images/pdf.png\' style="width:50%"></a>';
									}
								}

								else if (getFileExtension(data.expediente) == "xlsx") {

									if(data.idMovimiento == 35 || data.idMovimiento == 22 || data.idMovimiento == 62 || data.idMovimiento == 75){
										file = '<a href="../../static/documentos/cliente/corrida/' + data.expediente + '" ><img src="<?=base_url()?>static/images/excel.png" style="width:28%"/> <src="../../static/documentos/cliente/corrida/"' + data.expediente + '"></a> | <button type="button" title= "Eliminar archivo" id="deleteDoc" class="btn btn-danger delete" data-tipodoc="'+data.movimiento+'" data-iddoc="'+data.idDocumento+'" ><span class="glyphicon glyphicon-trash"></span></i></button>';
									} else {
										file = '<a href="../../static/documentos/cliente/corrida/' + data.expediente + '" ><img src="<?=base_url()?>static/images/excel.png" style="width:28%"/> <src="../../static/documentos/cliente/corrida/"' + data.expediente + '"></a>';
									}
									...
									file = '<a class="btn btn-primary pdfLink2" data-idc="'+data.id_cliente+'" data-nomExp="'+data.expediente+'" title= "Depósito de seriedad"><i class="fa fa-clipboard" aria-hidden="true"></i></a>';
								}
								else if (getFileExtension(data.expediente) == "Autorizaciones") {
									file = '<a href="#" class="btn btn-danger seeAuts" title= "Autorizaciones" data-id_autorizacion="'+data.id_autorizacion+'" data-idLote="'+data.idLote+'"><i class="fa fa-key" aria-hidden="true"></i></a>';
								}
								...
								{
									file = '<a class="pdfLink" data-Pdf="'+data.expediente+'" data-nomExp="'+data.expediente+'"><img src="<?=base_url()?>static/documentos/cliente/expediente/'+data.expediente+'" style="cursor:pointer;width:50%"/></a>';
								}
								return file;
							}
						},

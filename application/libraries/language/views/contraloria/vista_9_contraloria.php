...
if(data.idStatusContratacion == 8 && data.idMovimiento == 38 && data.perfil == 'asistentesGerentes' ||
	data.idStatusContratacion == 8 && data.idMovimiento == 65 && data.perfil == 'asistentesGerentes') {
...
dataExp1.append("totalNeto2", totalNeto2);
      ...
      if (validaComent == 0 || validatn == 0 || validatn2 == 0) {
				alerts.showNotification("top", "right", "Todos los campos son obligatorios.", "danger");
	  }
	  
      if (validaComent == 1 && validatn == 1 && validatn2 == 1) {

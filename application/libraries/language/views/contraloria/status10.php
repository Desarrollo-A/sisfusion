...
<script>
	$(document).ready(function()
	{
			...
			}).done(function(data)
		{
			...
			$('#showDate').append('10. Solicitud de validación de enganche y envio de contrato a RL (Contraloría) al día de hoy: ' + data);
		}).fail(function()
		{
		...
		var table = $('#Jtabla').dataTable( {
			"ajax":
				{
					"url": '<?=base_url()?>index.php/contraloria/getRevision10',
					"dataSrc": ""
				},
			"select": true,
			"scrollX":        true,

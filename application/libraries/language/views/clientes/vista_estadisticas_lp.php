					...
					<div class="container-fluid">
						<div class="card" >
							...
							<div class="card-content">
								<h4 class="card-title"> Estadísticas Lugar de Prospección</h4>
								<div class="row">
											...
											<div class="box-header with-border">
												<form id="formUsuario" name = "formUsuario" ng-submit="function()" novalidate>
													...
													<div class="row">
														...
														<div class="col-md-3 form-group">
															...
															<button type="button" ng-click="ObtenerReporte(datos)" title="Generar Gráfico Nuevo"
																	class="btn btn-block" style="background-color: #884EA0;color: #FFFFFF;">
																<span ng-show="searchButtonText == 'Searching'"><i class="glyphicon glyphicon-refresh spinning"></i></span>{{ searchButtonText }}</button>
														</div>
													...
													<div class="row">
														...
														<div class="col-md-3">
															<button type="button" title="Descargar Gráfica" style="background-color: #0E6655;"
																	class="btn btn-block" ng-click="Download(datos)">Descargar Gráfica</button>
														</div>

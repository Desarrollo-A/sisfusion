        ...
        <div class="modal-content">
            ...
            <form id="my_reasign_form_sm" name="my_reasign_form_sm" method="post">
                <div class="col-lg-12 form-group">
                    <label>Gerente</label>
                    <select class="selectpicker" name="id_gerente" id="myselectgerente" data-style="select-with-transition" onchange="getAdvisers(this)" title="Seleccione una opción" data-size="7"></select>
                </div>
                <div class="col-lg-12 form-group">
                    <label>Asesor</label>
                    <select class="selectpicker" name="id_asesor" id="myselectasesor" data-style="select-with-transition" multiple title="Seleccione una opción" data-size="7"></select>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="my_reasign_form_gm" name="my_reasign_form_gm" method="post">
                <div class="col-lg-12 form-group">
                    <label>Asesor</label>
                    <select class="selectpicker" name="id_asesor" id="myselectasesor2" data-style="select-with-transition" multiple title="Seleccione una opción" data-size="7"></select>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="my_reasign_form_ve" name="my_reasign_form_ve" method="post">
                <div class="col-lg-12 form-group">
                    <label>Gerente</label>
                    <select class="selectpicker" name="id_gerente" id="myselectgerente2" data-style="select-with-transition" onchange="getCoordinatorsByManager(this)" title="Seleccione una opción" data-size="7"></select>
                </div>
                <div class="col-lg-12 form-group">
                    <label>Coordinador</label>
                    <select class="selectpicker" name="id_coordinador" id="myselectcoordinador" data-style="select-with-transition" onchange="getAdvisersByCoordinator(this)" title="Seleccione una opción" data-size="7"></select>
                </div>
                <div class="col-lg-12 form-group">
                    <label>Asesor</label>
                    <select class="selectpicker" name="id_asesor" id="myselectasesor3" data-style="select-with-transition" multiple title="Seleccione una opción" data-size="7"></select>
                </div>
                        ...
                        <div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group label-floating div-curp">
                                    ...
                                    <input id="curp" name="curp" type="text" class="form-control" minlength="18" maxlength="18">
                                </div>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group label-floating div-phone-number">
                                    ...
                                    <input id="phone_number" name="phone_number" type="text" class="form-control" maxlength="10" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                </div>
                            </div>
                            <div class="col-sm-3">

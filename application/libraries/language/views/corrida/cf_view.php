...
<head>
  ...
  <?php
    if($this->session->userdata('id_rol') == FALSE || $this->session->userdata('id_rol') != '7' && $this->session->userdata('id_rol') != '16' && $this->session->userdata('id_rol') != '6' && $this->session->userdata('id_rol') != '2')
    {
    ...
    <!-- ///////////////////////////////////////////// -->
      ...
      <div id="areaImprimir">
            ...
            <div class="row">
              ...
              <label>Gerente:</label>
              <select ng-model = "gerente" ng-options = "item.nombreGerente for item in gerentes" ng-change="onSelectChangegerente(gerente)" class="form-control">
                  ...
                  <div ng-repeat="descuento in paquete.response | orderBy:'-apply'">
                         ...
                         <div ng-if="descuento.apply == 1">
                          ...
                          <span ng-if="descuento.id_condicion == 7" class="animate-if" style="color:#000;">Enganche diferido sin descontar MSI</span>
                                     ...
                                     <span ng-if="descuento.id_descuento == 78" class="animate-if" style="color:#DB3714;">(Aplica solo ventas online)</span>
          ...
          <table class="table table-striped table-bordered table-hover table-condensed">
            ...
            <tr ng-repeat="i in decFin">
                ...
                <span ng-if="i.id_condicion == 7"> Enganche diferido sin descontar MSI </span>
...
///////////////////////DESCIPCION DE DESCUENTOS////////////////////////////////////////
        ...
        || $scope.descDateEng0S1YS2 == 1 || $scope.engancheDiezMilLSLP == 1) {
            ...
            function (response) {
               ...
               $scope.selectDescuentos = function(descuento, checked){
                     ...
                     if (idx >= 0 && !checked) {
                        ...
                        $scope.descApply = descuentosAplicados;
                           ...
                           for(var descuentos of $scope.descApply){
                              ...
                              if(descuentos.id_paquete == 261 || descuentos.id_paquete == 151 || descuentos.id_paquete == 229 || descuentos.id_paquete == 263 || descuentos.id_paquete == 268 || descuentos.id_paquete == 269 
                ...
                || descuentos.id_paquete == 313
                                  ...
                                  } else if (descuentos.id_paquete == 229){
                                       $scope.descMSI = 1;
                     ...
                     $scope.engancheDiezMilLSLP = 1;
                              ...
                              } else if (descuentos.id_paquete != 261 || descuentos.id_paquete != 151 || descuentos.id_paquete != 229 || descuentos.id_paquete != 263 || descuentos.id_paquete != 268 

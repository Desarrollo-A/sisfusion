                                    ...
                                    $.each( resultArr, function( i, v){
                                        ...
                                        $("#modal_NEODATA .modal-body").append(`<div class="row"><div class="col-md-3">
                                                ...
                                                if(i == resultArr.length -1){
                                                    ...
                                                    <input type="hidden" name="id_disparador" id="id_disparador" value="1">
                                        ...
                                        $.getJSON( general_base_url + "Comisiones/getDatosAbonadoSuma11/"+idLote + "/1").done( function( data1 ){
                                            ...
                                            $.getJSON( general_base_url + "Comisiones/getDatosAbonadoDispersion/"+idLote + "/0").done( function( data ){
                                                ...
                                                $.each( data, function( i, v){
                                                    ...
                                                    $("#modal_NEODATA .modal-body").append(`<div class="row">
                                                    <div class="col-md-3"><input id="id_disparador" type="hidden" name="id_disparador" value="2"><input type="hidden" name="pago_neo" id="pago_neo" value="${total.toFixed(3)}">
                                                    <input type="hidden" name="pending" id="pending" value="${pending}"><input type="hidden" name="idLote" id="idLote" value="${idLote}">
                                                    <input id="rol" type="hidden" name="id_comision[]" value="${v.id_comision}"><input id="id_usuario" type="hidden" name="id_usuario[]" value="${v.id_usuario}">

...
$(document).ready(function () {
    ...
    $("#tabla_dispersar_comisiones tbody").on('click', '.btn-penalizacion', function () {
        ...
        $("#penalizacion-modal .modal-header").append(`
            	<h4 class="modal-title"> Penalización + 90 días, al lote <b> ${nombreLote} </b>
                </h4>
                <BR><P>Al aprobar esta penalización no se podrán revertir los descuentos y se dispersara el pago de comisiones con los porcentajes correspondientes.</P>`);
    ...
    $("#tabla_dispersar_comisiones tbody").on('click', '.btn-penalizacion4', function () {
        ...
        $("#penalizacion4-modal .modal-header").append(`
            <h4 class="modal-title">Penalización + 160 días, al lote <b> ${nombreLote} </b>
            </h4>
            <BR><P>Al aprobar esta penalización no se podrán revertir los descuentos y se dispersara el pago de comisiones con los porcentajes asignados.</P>
            `);
    ...
    $("#tabla_dispersar_comisiones tbody").on('click', '.btn-Nopenalizacion', function () {
        ...
        $("#Nopenalizacion-modal .modal-header").append(`
            <h4 class="modal-title"> Cancelar Penalización + 90 días, al lote <b> ${nombreLote} </b>
            </h4>
            <BR><P>Al cancelar esta penalización no se podrán revertir los cambios.</P>`);
        ...
        if (parseFloat(totalNeto2) > 0) {
                ...
                if (data.length > 0) {
                    switch (data[0].Marca) {
                        case 0:
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h4><b>En espera de próximo abono en NEODATA de  ${row.data().nombreLote} .</b>
                                    </h4><br>
                                    <h5>Revisar con Administración.
                                    </h5>
                                </div> 
                                <div class="col-md-12">
                                    <center>
                                        <img src=" ${general_base_url}static/images/robot.gif" width="320" height="300">
                                    </center>
                                </div>
                            </div>`);
                            break;
                            ...
                            if (registro_comision == 0 || registro_comision == 8 || registro_comision == 2) {
                                ...
                                $("#modal_NEODATA .modal-body").append(`
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <h3>Lote: 
                                                <b>${row.data().nombreLote}${labelPenalizacion}</b>
                                            </h3>
                                    ...
                                    <div class="col-md-3 p-0">
                                            <h5>Precio lote: 
                                                <b>$${formatMoney(totalNeto2)}</b>
                                            </h5>
                                    </div>
                                    <div class="col-md-3 p-0">
                                            <h5>$ Neodata: 
                                                <b style="color:${data[0].Aplicado <= 0 ? 'black' : 'blue'};"> 
                                                $ ${formatMoney(data[0].Aplicado)}</b>
                                            </h5>
                                    </div>
                                    <div class="col-md-3 p-0">
                                            <h5>Disponible: 
                                ...
                                if (total > (new_validate + 1) && (id_estatus == 9 || id_estatus == 10 || id_estatus == 11 || id_estatus == 12 || id_estatus == 13 || id_estatus == 14)) {
                                    ...
                                    $("#modal_NEODATA .modal-body").append(`
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3><i class="fa fa-info-circle" style="color:gray;"></i>
                                                        <b style="color:blue;"> Anticipo </b> 
                                                        diponible 
                                                    <i> ${row.data().nombreLote} </i>
                                                </h3>
                                            </div>
                                        </div>
                                        <br><br>`);
                                        ...
                                        <div class="row">
                                            <div class="col-md-12"><h3>
                                                <i class="fa fa-info-circle" style="color:gray;"></i>
                                                    <b style="color:blue;"> Anticipo 5%</b> disponible 
                                                <i> ${row.data().nombreLote}</i>
                                                </h3>
                                            </div>
                                        </div>
                                ...
                                $.getJSON(general_base_url + "Comisiones/porcentajes/" + idCliente + "/" + plan_comision).done(function (resultArr) {
                                    $.each(resultArr, function (i, v) {
                                        ...
                                        $("#modal_NEODATA .modal-body").append(`<div class="row"><div class="col-md-3">
                                            ...
                                            <div class="col-md-1"><input class="form-control ng-invalid ng-invalid-required" name="porcentaje[]"  required readonly="true" type="hidden" value="${v.porcentaje_decimal % 1 == 0 ? parseInt(v.porcentaje_decimal) : parseFloat(v.porcentaje_decimal)}">
                                                <input class="form-control ng-invalid ng-invalid-required" required readonly="true" value="${v.porcentaje_decimal % 1 == 0 ? parseInt(v.porcentaje_decimal) : v.porcentaje_decimal.toString().match(/^-?\d+(?:\.\d{0,2})?/)[0]}%"></div>
                                    ...
                                    $("#modal_NEODATA .modal-footer").append(`
                                                ...
                                                <button type="submit" class="btn btn-gral-data" name="disper_btn"  id="dispersar" value="Dispersar">Dispersar</button>
                                                `);
                                });
                            }
                            else {
                                $.getJSON(general_base_url + "Comisiones/getDatosAbonadoSuma11/" + idLote).done(function (data1) {
                                    ...
                                    $("#modal_NEODATA .modal-body").append(`
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3>
                                                    <i class="fa fa-info-circle" style="color:gray;"></i>
                                                    Saldo diponible para <i>  ${row.data().nombreLote} </i> : 
                                                    <b>$ ${formatMoney(total0 - (data1[0].abonado))} </b>
                                                 </h3>
                                            </div>
                                        </div>
                                        <br>`);
                                    ...
                                    $.getJSON(general_base_url + "Comisiones/getDatosAbonadoDispersion/" + idLote).done(function (data) {
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <p style="font-zise:10px;"><b>USUARIOS</b></p>
                                            </div>
                                            <div class="col-md-1">
                                                <b>%</b>
                                            </div>
                                                <div class="col-md-2"><b>TOT. COMISIÓN</b>
                                                </div>
                                            <div class="col-md-2">
                                                <b><b>ABONADO</b>
                                            </div>
                        ...
                        case 2:
                            $("#modal_NEODATA .modal-body").append(`
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4> <b>
                                            No se encontró esta referencia de ${row.data().nombreLote} 
                                            .</b>
                                        </h4><br>
                                        <h5>
                                            Revisar con Administración.
                                        </h5>
                                    </div> 
                                    <div class="col-md-12">
                                        <center>
                        ...
                        case 3:
                            $("#modal_NEODATA .modal-body").append(`
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4><b>No tiene vivienda, si hay referencia de  ${row.data().nombreLote} .</b></h4>
                                        <br>
                                        <h5>Revisar con Administración.</h5>
                                    </div>
                                    <div class="col-md-12">
                                        <center><img src="${general_base_url}static/images/robot.gif" width="320" height="300">
                                        </center>
                                    </div> 
                                </div>`);
                            break;
                        case 4:
                            $("#modal_NEODATA .modal-body").append(`
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4><b>No hay pagos aplicados a esta referencia de  ${row.data().nombreLote} .</b></h4>
                                        <br>
                                        <h5>Revisar con Administración.</h5>
                                    </div>
                                    <div class="col-md-12">
                        ...
                        case 5:
                            $("#modal_NEODATA .modal-body").append(`
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4><b>Referencia duplicada de  ${row.data().nombreLote} .</b></h4>
                                        <br>
                                        <h5>Revisar con Administración.</h5>
                                    </div> 
                                    <div class="col-md-12">
                        ...
                        default:
                            $("#modal_NEODATA .modal-body").append(`
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4><b>Aviso.</b></h4><br>
                                        <h5>Sistema en mantenimiento: .</h5>
                                    </div> 
                                    <div class="col-md-12">
                                        <center>
                                            <img src="${general_base_url}static/images/robot.gif" width="320" height="300">
                    ...
                    $("#modal_NEODATA .modal-body").append(`
                        <div class="row">
                            <div class="col-md-12">
                                <h3><b>No se encontró esta referencia en NEODATA de  ${row.data().nombreLote} .</b>
                                </h3><br>
                                <h5>Revisar con Administración.</h5></div> <div class="col-md-12">
                                <center>
                                    <img src=" ${general_base_url}static/images/robot.gif" width="320" height="300">
                                </center>
                            </div> 
            ...
            $("#modal_NEODATA .modal-body").append(`
                <div class="row">
                    <div class="col-md-12">
                        <h3>
                            <b>El lote  ${row.data().nombreLote}  presenta una inconsistencia, favor de revisar con sistemas o validar que tenga una referencia en inventario 
                            </b>
                        </h3><br>
                        <h5>
                            Revisar con Administración.
...
$('#fecha2').change(function () {
    ...
    if (fecha1 == '') {
        ...
        // cambianddo los datos para subirse
        $.getJSON(general_base_url + "Comisiones/getMontoDispersadoDates/" + fecha1 + '/' + fecha2).done(function ($datos) {
            $("#myModal .modal-body").append(`
                <div class="row">             
                    <div class="col-md-5"><p class="category"><b>Monto</b>:
                        <br> 
                       <label class="lbl-deepGray"> <b>$  ${formatMoney($datos['datos_monto'][0].monto)} </b> </label>
                        </p>
                    </div>
                    <div class="col-md-4">
                        <p class="category">
                        <b>Pagos</b>:
                        <br> 
                        <label class="lbl-deepGray" > <b>  ${formatMiles($datos['datos_monto'][0].pagos)} </b> </label> </p>
                        </div><div class="col-md-3"><p class="category">
                        <b>Lotes</b>:
                        <br> 
                        <label class="lbl-deepGray" > <b>  ${formatMiles($datos['datos_monto'][0].lotes)} </b> </label> </p>
                    </div>
                </div>`);
        });
    }
...
$('#btn-detalle-plan').on('click', function () {
    $('#planes-div').show();
    $("#detalle-plan-modal .modal-header").html("");
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#detalle-plan-modal .modal-header").append(`
                <h4 class="modal-title  center-align">
                    <b>Planes de comisión</b>
                </h4>`);

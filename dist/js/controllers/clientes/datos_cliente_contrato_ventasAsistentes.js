$(document).ready(function () {
  ...
  $.post(
    general_base_url + "Asistente_gerente/lista_proyecto",
    function (data) {
      var len = data.length;
      for (var i = 0; i < len; i++) {
...
$("#proyecto").change(function () {
  ...
  $(document).ready(function () {
    $.post(
      general_base_url + "Asistente_gerente/lista_condominio/" + index_proyecto,
      function (data) {
        var len = data.length;
        for (var i = 0; i < len; i++) {
...
$("#condominio").change(function () {
  ...
  $(document).ready(function () {
    $.post(
      general_base_url + "Asistente_gerente/lista_lote/" + index_condominio,
      function (data) {
        var len = data.length;
        for (var i = 0; i < len; i++) {
...
$("#lote").change(function () {
  ...
  $("#tabla_contrato_ventas tbody").on(
    "click",
    ".contratacion_modal",
    function () {
      $("#fileViewer").modal();

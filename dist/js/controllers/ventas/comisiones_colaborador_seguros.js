...
$(document).on("click", ".subir-archivo", function (e) {
    ...
    $('#archivo-extranjero').val('');
    $.ajax({
        url: general_base_url+'Seguros/getTotalComisionAsesor',
        type: 'GET',
        dataType: 'JSON',
...
function requestCodigoPostal(){
    $.ajax({
        url: general_base_url + 'Seguros/consulta_codigo_postal',
        cache: false,
        contentType: false,
        processData: false,
        type: 'GET',
...
$(document).on("submit", "#cpForm", function (e) {
    ...
    $.ajax({
        url: general_base_url + 'Seguros/insertar_codigo_postal',
        data: data,
        cache: false,
        contentType: false,
        processData: false,
...
$(document).ready(function () {
    $.ajax({
        url: general_base_url + 'Seguros/getFechaCorteActual',
        cache: false,
        contentType: false,
        processData: false,
        type: 'GET',
...
$("#tabla_nuevas_comisiones").ready(function () {
    ...
    tabla_nuevas = $("#tabla_nuevas_comisiones").DataTable({
            ...
            action: function () {
                ...
                if(
                    ...
                    if ($('input[name="idT[]"]:checked').length > 0) {
                        ...
                        $.ajax({
                            url: general_base_url + 'Seguros/acepto_comisiones_user/',
                            data: com2,
                            cache: false,
                            contentType: false,
                            processData: false,
        ...
        ajax: {
            "url": general_base_url + "Seguros/getDatosComisionesAsesor/" + 1,
            "type": "POST",
            cache: false,
            "data": function (d) { }
        },
...
$("#tabla_revision_comisiones").ready(function () {
    ...
    tabla_revision = $("#tabla_revision_comisiones").DataTable({
        ...
        ajax: {
            "url": general_base_url + "Seguros/getDatosComisionesAsesor/" + 4,
            "type": "POST",
            cache: false,
            "data": function (d) { }
        },
...
$("#tabla_pagadas_comisiones").ready(function () {
    ...
    tabla_pagadas = $("#tabla_pagadas_comisiones").DataTable({
        ...
        ajax: {
            url: general_base_url + "Seguros/getDatosComisionesAsesor/" + 8,
            type: "POST",
            cache: false,
            data: function (d) { }
        },
...
function fillCommissionTableWithoutPayment(proyecto, condominio) {
    tabla_comisiones_sin_pago = $("#tabla_comisiones_sin_pago").DataTable({
        ...
        ajax: {
            url: general_base_url + "Seguros/getGeneralStatusFromNeodata/" + proyecto + "/" + condominio,
            type: "POST",
            cache: false,
            data: function (d) { }
        },
...
$(document).on("click", ".subir_factura", function () {
    ...
    link_post = "Seguros/guardar_solicitud/" + id_comision;
...
function EnviarDesarrollos() {
    ...
    formData.append("dato", "valor");
    $.ajax({
        url: general_base_url + 'Seguros/EnviarDesarrollos',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
$(document).on("click", ".subir_factura_multiple", function() {
    ...
    if(
        ...
        $('#desarrolloSelect').change(function () {
            ...
            $("#modal_multiples .modal-body").html("");
            $.getJSON(general_base_url + "Seguros/getDatosProyecto/" + valorSeleccionado).done(function (data) {
                if (!data) {
...
function subir_xml(input) {
    ...
    resear_formulario();
    $.ajax({
        url: general_base_url + "Seguros/cargaxml",
        data: data,
        cache: false,
        contentType: false,
        processData: false,
...
function subir_xml2(input) {
    ...
    resear_formulario();
    $.ajax({
        url: general_base_url + "Seguros/cargaxml2",
        data: data,
        cache: false,
        contentType: false,
        processData: false,
...
$("#eliminar_factura").submit(function (e) {
    ...
    submitHandler: function (form) {
        ...
        $.ajax({
            url: general_base_url + "Seguros/borrar_factura",
            data: data,
            cache: false,
            contentType: false,
            processData: false,
...
function save2() {
    ...
    $.ajax({
        url: general_base_url + 'Seguros/guardar_solicitud2',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,

...
function fillDocumentsList(v, i) {
    let disabled_option = myFunctions.revisaObservacionUrgente(v.observacionContratoUrgente);
    var seleccion = $("#lotes_escrituracion").val();
    ...
    $("#documentsList").append(btnMostrarDoc);

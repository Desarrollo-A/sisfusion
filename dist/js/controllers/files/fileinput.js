...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div class="file-caption form-control {class}" tabindex="500">\n' +
                ...
                '</div>';
            //noinspection HtmlUnknownAttribute
            tBtnDefault = '<button style="margin-right: 10px; type="{type}" tabindex="500" title="{title}" class="{css}" ' +
            ...
            tImage = '<img src="{data}" class="file-preview-image kv-preview-data" title="{title}" ' +
                'alt="{alt}"' + tStyle + '>\n';
            tText = '<div class="kv-preview-data file-preview-other-frame"' + tStyle + '>\n' + $h.DEFAULT_PREVIEW + '\n</div>\n';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    uploadRetryTitle: 'Reintentar carga',
                    ...
                    indicatorNewTitle: 'Aún no subido',
                    indicatorSuccessTitle: 'Subido',
                    indicatorErrorTitle: 'Error al subir',
                    indicatorLoadingTitle: 'Cargando &hellip;',
                    indicatorPausedTitle: 'Carga pausada'
                }
            };
    ...
    $.fn.fileinputLocales.en = {
        ...
        removeTitle: 'Borrar todos los archivos no procesados',
        cancelLabel: 'Cancelar',
        cancelTitle: 'Anular carga continua',
        pauseLabel: 'Pausar',
        pauseTitle: 'Pausar carga continua',
        uploadLabel: 'Subir',
        ...
        msgFileRequired: 'Debe seleccionar un archivo para cargar.',
        msgSizeTooSmall: 'Archivo "{name}" (<b>{size} KB</b>) es demasiado pequeño y debe ser más grande que <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede el tamaño de carga máximo permitido de <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Debe seleccionar al menos <b>{n}</b> {files} a subir.',
        msgFilesTooMany: 'Número de archivos seleccionados para subir <b>({n})</b> excede el límite máximo permitido de <b>{m}</b>.',
        msgTotalFilesTooMany: 'Puede subir un máximo de <b>{m}</b> archivos (<b>{n}</b> archivos detectados).',
        ...
        msgFilePreviewAborted: 'Vista previa de archivo cancelada por "{name}".',
        msgFilePreviewError: 'Se produjo un error al leer el archivo "{name}".',
        msgInvalidFileName: 'Caracteres no válidos o no compatibles en el nombre del archivo "{name}".',
        msgInvalidFileType: 'Tipo no válido para el archivo "{name}". Solamente "{types}" archivos son permitidos.',
        msgInvalidFileExtension: 'Extensión no válida para el archivo "{name}". Solamente "{extensions}" archivos son soportados.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadAborted: 'La carga del archivo fue cancelada.',
        msgUploadThreshold: 'Procesando &hellip;',
        msgUploadBegin: 'Inicializando &hellip;',
        msgUploadEnd: 'Hecho',
        msgUploadResume: 'Reanudando la carga &hellip;',
        ...
        msgProgress: 'Cargando arvhivo {index} de {files} - {name} - {percent}% completed.',
        msgSelected: '{n} {files} selected',
        msgFoldersNotAllowed: 'Arrastrar y soltar archivos solamente! {n} se emitieron las carpetas.',
        msgImageWidthSmall: 'Ancho del archivo de imagen "{name}" debe ser por lo menos {size} px.',
        msgImageHeightSmall: 'Largo del archivo de imagen "{name}" debe ser por lo menos {size} px.',
        msgImageWidthLarge: 'Ancho del archivo de imagen "{name}" no puedes exceder {size} px.',
        msgImageHeightLarge: 'Largo del archivo de imagen "{name}" no puedes exceder {size} px.',
        msgImageResizeError: 'No se pudieron cambiar las dimensiones de la imagen.',
        msgImageResizeException: 'Error al cambiar el tamaño de la imagen.<pre>{errors}</pre>',
        msgAjaxError: 'Algo salió mal con la {operation} operación. ¡Por favor, inténtelo de nuevo más tarde!',
        msgAjaxProgressError: '{operation} falló',
        msgDuplicateFile: 'Archivo "{name}" del mismo tamaño "{size} KB" ya ha sido seleccionado anteriormente. Omitiendo selección duplicada.',
        msgResumableUploadRetriesExceeded: '¡Subida cancelada más allá <b>{max}</b> reintentos para el archivo <b>{file}</b>! Detalles del error: <pre>{error}</pre>',
        msgPendingTime: '{time} restante',
        msgCalculatingTime: 'calculando tiempo retante',
        ajaxOperations: {
            deleteThumb: 'Eliminar archivo',
            uploadThumb: 'Subir archivos',
            uploadBatch: 'Carga de archivos por lotes',
            uploadExtra: 'Subir datos del formulario'
        },
        ...
        previewZoomButtonTitles: {
            ...
            toggleheader: 'Alternar encabezado',
            fullscreen: 'Alternar pantalla completa',
            borderless: 'Alternar modo sin bordes',

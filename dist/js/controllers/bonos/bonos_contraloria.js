...
$("#tabla_bonos").ready( function(){
    ...
    tabla_bonos1 = $("#tabla_bonos").DataTable({
        ...
        ajax: {
            "url": general_base_url + "Bonos/getBonos",
            "type": "POST",
            cache: false,
            "data": function( d ){
            }
    ...
    $("#tabla_bonos tbody").on("click", ".consulta_abonos", function() {
        ...
        $.getJSON(general_base_url + "Bonos/getHistorialAbono/" + id).done(function(data) {
            if (data.length == 0) {
    ...
    $("#tabla_bonos tbody").on("click", ".btn-delete", function(){    
        ...
        $.getJSON(general_base_url + "Bonos/TieneAbonos/" + id).done(function(data) {
        if(data == 1){
...
$(document).on('submit','#form-delete', function(e){ 
    ...
    $.ajax({
        method: 'POST',
        url: general_base_url + 'Bonos_model/BorrarBono',
        data: formData,
        processData: false,
        contentType: false,
        success: function(data) {
...
$("#form_abono").on('submit', function(e){
    ...
    $.ajax({
        method: 'POST',
        url: general_base_url + 'Bonos/InsertAbono',
        data: formData,
        processData: false,
        contentType: false,
        success: function(data) {

...
let BUTTONREGRESO = '';
    ...
    if ((idEstatusPreproceso === 6 && id_rol_general == 7) || (idEstatusPreproceso === 6 && id_rol_general === 3 && id_usuario_general == d.idAsesorAsignado)) // EEC: CONFIRMACIÓN DE RECEPCIÓN DE DOCUMENTOS

        ...
        },
        {
            ...
            "data": function (data) {
                ...
                if (data.vl == '1') {
                    ...
                    if (Array(2762, 6096, 6864, 10937, 10938, 12136, 12173, 13015, 2747,13498, 15041, 15042, 15042).includes(user) ){
                    ...
                    if ((Array("2762", "2845", "2747").includes(data.user) || Array(6096, 6864, 10937, 10938, 12136, 12173, 13015, 13498, 15041, 15042, 15042).includes(user))) {

    ...
    columns: [
      ...
      },
      {
        data: function (d) {
          if (d.idMovimiento == 4 || d.idMovimiento == 74 || d.idMovimiento == 93 || d.idMovimiento == 103)
            return `<span class="label lbl-warning">CORRECIÃ“N</span>`;
          else
      ...
      },
      {
        ...
        data: function (data) {
          ...
          if (data.vl == '1') {
            cntActions = 'EN PROCESO DE LIBERACIÃ“N';
    ...
    if (row.child.isShown()) {
      ...
      if (
        ...
        (row.data().idStatusContratacion == 2 && row.data().idMovimiento == 93)
          ...
          status = 'Status 2 enviado a RevisiÃ³n (Asesor)';
      ...
      informacion_adicional +=
      '          <label><b>InformaciÃ³n adicional</b></label>';

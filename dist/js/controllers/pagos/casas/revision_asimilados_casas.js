...
//             total_casa += parseFloat(v.impuesto);
//         });
//         var to = formatMoney(numberTwoDecimal(total_casa));
...
//         var tra = $(this).closest('tr');
//         var row = tabla_asimilados_casas.row( tra );
//         id_pago_i = $(this).val();
...
//         if(this.checked){
//             tra = this.closest('tr');
//             row = tabla_asimilados_casas.row(tra).data();

...
$(document).on("click", ".subir-archivo", function (e) {
    ...
    $('#archivo-extranjero').val('');
    $.ajax({
        url: 'Casas_comisiones/getTotalComisionAsesor',
        type: 'GET',
        dataType: 'JSON',
...
$("#tabla_nuevas_comisiones").ready(function () {
        ...
        },
        {
            "data": function (d) {
                switch (d.forma_pago) {
                    ...
                    case 5:
                        return `<p class="mb-1">
                                    <span class="label lbl-sky">FACTURA EXTRANJERO</span>
                                </p>
                        `;
                    default:
                        return `<p class="mb-1">
    ...
    $("#tabla_nuevas_comisiones tbody").on("click", ".excedente1", function (e) {
        ...
        var porciento1 = ``;
        if(proceso == 1){
            $.getJSON("Casas_comisiones/resumenIndividual/" + idLote+"/"+proceso).done(function (data) {
...
$("#tabla_revision_comisiones").ready(function () {
    ...
    tabla_revision = $("#tabla_revision_comisiones").DataTable({
        ...
        },
        {
            "orderable": false,
            "data": function (d) {
                return '<p class="mb-0"><span class="label lbl-sky">REVISIÓN CONTRALORÍA</span></p>';
            }
        },
        {
            "data": function (data) {
...
$("#tabla_otras_comisiones").ready(function () {
    ...
    tabla_otras = $("#tabla_otras_comisiones").DataTable({
        ...
        },
        {
            "orderable": false,
            "data": function (d) {
                return '<p class="m-0"><span class="label lbl-sky">EN PAUSA</span></p>';
            }
        },
        {
            "data": function (data) {

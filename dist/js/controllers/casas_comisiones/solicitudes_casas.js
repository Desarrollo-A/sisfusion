...
$("#EditarPerfilExtranjeroForm").one('submit', function (e) {
    ...
    $.ajax({
        type: 'POST',
        url: general_base_url + 'Casas_comisiones/SubirPDFExtranjero',
        data: formData,
        contentType: false,
        cache: false,
        processData: false,
...
function requestCodigoPostal(){
    $.ajax({
        url: general_base_url + 'Casas_comisiones/consulta_codigo_postal',
        cache: false,
        contentType: false,
        processData: false,
        type: 'GET',
...
$(document).on("submit", "#cpForm", function (e) {
    ...
    $.ajax({
        url: general_base_url + 'Casas_comisiones/insertar_codigo_postal',
        data: data,
        cache: false,
        contentType: false,
        processData: false,
...
$(document).ready(function () {
    ...
    $.post(general_base_url + "Casas_comisiones/lista_proyecto", function (data) {
        var len = data.length;
        for (var i = 0; i < len; i++) {
    ...
    if(forma_pago == 3){
        if(tipo_usuario == 2){
            if (
                        ...
                        ||(mes == 2 && dia == 7) || (mes == 2 && dia == 8) // FEB 2024 OOAM QUINCENAL
...
$('#proyecto_wp').change(function () {
    ...
    $("#condominio_wp").html("");
    $(document).ready(function () {
        $.post(general_base_url + "Casas_comisiones/lista_condominio/" + index_proyecto, function (data) {
            var len = data.length;
...
function fillCommissionTableWithoutPayment(proyecto, condominio) {
    tabla_comisiones_sin_pago = $("#tabla_comisiones_sin_pago").DataTable({
        ...
        ajax: {
            url: general_base_url + "Casas_comisiones/getGeneralStatusFromNeodata/" + proyecto + "/" + condominio,
            type: "POST",
            cache: false,
            data: function (d) { }
        },
...
// El controlador no exite, revisar -------------------------------
...
function EnviarDesarrollos() {
    ...
    formData.append("dato", "valor");
    $.ajax({
        url: general_base_url + 'Casas_comisiones/EnviarDesarrollos',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
function subir_xml(input) {
    ...
    resear_formulario();
    $.ajax({
        url: general_base_url + "Comisiones/cargaxml", // Np existe el controlador
        data: data,
        cache: false,
        contentType: false,
        processData: false,
...
function subir_xml2(input) {
    ...
    resear_formulario();
    $.ajax({
        url: general_base_url + "Casas_comisiones/cargaxml2",
        data: data,
        cache: false,
        contentType: false,
        processData: false,
...
$("#eliminar_factura").submit(function (e) {
    ...
    submitHandler: function (form) {
        ...
        $.ajax({
            url: general_base_url + "Casas_comisiones/borrar_factura",
            data: data,
            cache: false,
            contentType: false,
            processData: false,

...
function function_totales(){
        $.getJSON( general_base_url + "Ooam/getMontoDispersado").done( function( data ){
        $cadena = '<b>$'+formatMoney(data[0].monto)+'</b>';
        document.getElementById("monto_label").innerHTML = $cadena ;
        });
        $.getJSON( general_base_url + "Ooam/getPagosDispersado").done( function( data ){
        $cadena01 = '<b>'+data[0].pagos+'</b>';
        document.getElementById("pagos_label").innerHTML = $cadena01 ;
        });
        $.getJSON( general_base_url + "Ooam/getLotesDispersado").done( function( data ){

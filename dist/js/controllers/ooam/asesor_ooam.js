...
$("#EditarPerfilExtranjeroForm").one('submit', function (e) {
    ...
    $.ajax({
        type: 'POST',
        url: general_base_url + 'Ooam/SubirPDFExtranjero',
        data: formData,
        contentType: false,
        cache: false,
        processData: false,
...
function requestCodigoPostal(){
    $.ajax({
        url: general_base_url + 'Ooam/consulta_codigo_postal',
        cache: false,
        contentType: false,
        processData: false,
        type: 'GET',
...
$(document).ready(function () {
    $.post(general_base_url + "Ooam/lista_proyecto", function (data) {
        var len = data.length;
        for (var i = 0; i < len; i++) {
...
$('#proyecto_wp').change(function () {
    ...
    $("#condominio_wp").html("");
    $(document).ready(function () {
        $.post(general_base_url + "Ooam/lista_condominio/" + index_proyecto, function (data) {
            var len = data.length;
...
$("#tabla_nuevas_comisiones").ready(function () {
    ...
    tabla_nuevas = $("#tabla_nuevas_comisiones").DataTable({
        ...
        },
        {
            ...
            action: function () {
                ...
                if (((mes == 1 && dia == 9) || (mes == 1 && dia == 10 && hora <= 13)) ||
                    ...
                    ((mes == 9 && dia == 11) || (mes == 9 && dia == 12 && hora <= fin)) ||
                    ((mes == 10 && dia == 9) || (mes == 10 && dia == 10 && hora <= fin)) ||
                    ((mes == 11 && dia >= 8) || (mes == 11 && dia == 15 && hora <= fin)) ||
                    ((mes == 12 && dia == 11) || (mes == 12 && dia == 12 && hora <= fin)) ||
                    ...
                    if ($('input[name="idT[]"]:checked').length > 0) {
                        ...
                        $.ajax({
                            url: general_base_url + 'Ooam/acepto_comisiones_user/',
                            data: com2,
                            cache: false,
                            contentType: false,
                            processData: false,
        ...
        ajax: {
            "url": general_base_url + "Ooam/getDatosComisionesAsesor/" + 1,
            "type": "POST",
            cache: false,
            "data": function (d) { }
        },
...
$("#tabla_revision_comisiones").ready(function () {
    ...
    tabla_revision = $("#tabla_revision_comisiones").DataTable({
        ...
        ajax: {
            "url": general_base_url + "Ooam/getDatosComisionesAsesor/" + 4,
            "type": "POST",
            cache: false,
            "data": function (d) { }
        },
...
$("#tabla_pagadas_comisiones").ready(function () {
    ...
    tabla_pagadas = $("#tabla_pagadas_comisiones").DataTable({
        ...
        ajax: {
            url: general_base_url + "Ooam/getDatosComisionesAsesor/" + 8,
            type: "POST",
            cache: false,
            data: function (d) { }
        },
...
$("#tabla_otras_comisiones").ready(function () {
    ...
    tabla_otras = $("#tabla_otras_comisiones").DataTable({
        ...
        ajax: {
            url: general_base_url + "Ooam/getDatosComisionesAsesor/" + 6,
            type: "POST",
            cache: false,
            data: function (d) { }
        },
...
function fillCommissionTableWithoutPayment(proyecto, condominio) {
    tabla_comisiones_sin_pago = $("#tabla_comisiones_sin_pago").DataTable({
        ...
        ajax: {
            url: general_base_url + "Ooam/getGeneralStatusFromNeodata/" + proyecto + "/" + condominio,
            type: "POST",
            cache: false,
            data: function (d) { }
        },
...
$(document).on("click", ".subir_factura", function () {
    ...
    link_post = "Ooam/guardar_solicitud/" + id_comision;
...
function EnviarDesarrollos() {
    ...
    formData.append("dato", "valor");
    $.ajax({
        url: general_base_url + 'Ooam/EnviarDesarrollos',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
function subir_xml2(input) {
    ...
    resear_formulario();
    $.ajax({
        url: general_base_url + "Ooam/cargaxml2",
        data: data,
        cache: false,
        contentType: false,
        processData: false,
...
$("#eliminar_factura").submit(function (e) {
    ...
    submitHandler: function (form) {
        ...
        $.ajax({
            url: general_base_url + "Ooam/borrar_factura",
            data: data,
            cache: false,
            contentType: false,
            processData: false,

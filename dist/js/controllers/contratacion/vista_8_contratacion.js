            ...
            tabla_6 = $("#Jtabla").DataTable({
                ...
                
                {
                    ...
                    data: function( data ){
                            ...
                            if(id_rol != 53 && id_rol != 54 && id_rol != 63) { // ANALISTA DE COMISIONES Y SUBDIRECTOR CONSULTA (POPEA)

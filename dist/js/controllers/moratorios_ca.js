...
{
    // console.log('IM', IM);
    // console.log('importeSaldoI', importeSaldoI);
    // console.log('posPay', posPay);
    // console.log('PositionPago', PositionPago);
    // console.log('diasRetardo', diasRetardo);
    // console.log('saldoInsoluto', saldoInsoluto);
    // console.log('minVal', minVal);
    // console.log('maxVal', maxVal);
    // console.log('arrayCheckAllPost', arrayCheckAllPost);
    // console.log('fechaDelPago', fechaDelPago);
...
//FIN FECHA
                                    ...
                                    else
                                    {
                                        ...
                                        if($scope.alphaNumeric[posPay]['disp']!=0 || $scope.alphaNumeric[posPay]['disp']==1)
                                        {
                                            ...
                                            else/*5654.61;*/
                                            {
                                                ...
                                                saldo = $scope.alphaNumeric[posPay]['saldo'] = $scope.infoMoratorio.si ;
                                                saldoMoraManipulable = saldo;
    ...
    if($scope.infoMoratorio.plazo >= 37 && $scope.infoMoratorio.plazo  <= 120) {
        console.log('alphaNumeric 1st', $scope.alphaNumeric);
        var range=[];
        ini = ($scope.mesesdiferir > 0) ? $scope.mesesdiferir : $scope.infoMoratorio.contadorInicial;
        if($scope.infoMoratorio.plazo >= 0 && $scope.infoMoratorio.plazo <=120)
        {
            // console.log('grupo2 alabergaaaaa');
            for (var i = ini; i <= $scope.infoMoratorio.mesesSinInteresP1-1; i++)
            {
                if(mes == 13){
                    mes = '01';
            ...
            for (var i = ini2; i < $scope.infoMoratorio.plazo; i++) {
                ...
                // console.log('entré directamente como si no tuviese msi');
                if(mes == 13){
                    mes = '01';
                    yearc++;
                }
                ...
                if($scope.alphaNumeric[i]['disp'] != 1 || $scope.alphaNumeric[posPay]['disp']==1)
                {
                    ...
                    if (vuelta == posicionPago)
                    {
                        ...
                        {/* Este else es para ver si se descuenta apartir de la segunda posicion*/
                            ...
                            console.log('posicionPago',posicionPago);
                            console.log('posPay',posPay);
                            console.log('$scope.alphaNumeric[posPay]',$scope.alphaNumeric[posPay]);
                            // console.log('posPay', posPay);
                            // console.log('alphaNumeric F1', $scope.alphaNumeric);
                                            ...
                                            if(checkMoratorios>0 || checkOrdinarios>0){
                                                ...
                                                if(checkMoratorios>0){
                                                    ...
                                                    if(provA>checkMoratoriosII){
                                                        ...
                                                        // console.log('2', deudaMoratorio);
                                                        // console.log('checkMoratoriosII', checkMoratoriosII);
                                                        let sumatoriaMoratoriosIT2 = sumaMaratorios();
                                                        console.log('sumatoriaMoratoriosIT', sumatoriaMoratoriosIT2);
                                                        $('#acumuladoBruto').val(sumatoriaMoratoriosIT2.toFixed(2));
                                                        // /*setear el valor al input de prueba*/
                                                        $('#resMoratorioAdeuto').val(sumatoriaMoratoriosIT2);
                                                        $('#resMoratorioAdeuto').click();
                ...
                console.log("Part of range II de JS EXTERNO TESTING");
                mes++;
    ...
    if($scope.infoMoratorio.plazo >= 121 && $scope.infoMoratorio.plazo  <= 240) {
        console.log('cayó en el grupo 3');
        ...
        if($scope.infoMoratorio.plazo >= 0 && $scope.infoMoratorio.plazo <=240)
        {
                ...
                if($scope.alphaNumeric[i]['disp'] != 1 || $scope.alphaNumeric[posPay]['disp']==1)
                {
                    ...
                    if (vuelta == posicionPago)
                    {
                        ...
                        {/* Este else es para ver si se descuenta apartir de la segunda posicion*/
                            ...
                            console.log('interes moratorio hereeeee',i,':', IM);
                            console.log('$scope.alphaNumeric[posPay][\'saldo\'];',i,':', $scope.alphaNumeric[posPay]['saldo']);
                            console.log('$scope.infoMoratorio.si', $scope.infoMoratorio.si);
                            console.log('saldo', saldo);
                            if(IM > 0)
                            {
                                if($scope.alphaNumeric[posPay]['disp']!=0 || $scope.alphaNumeric[posPay]['disp']==1)
            ...
            /////////////
            $scope.p3 = ($scope.infoMoratorio.interes_p3 *  Math.pow(1 + $scope.infoMoratorio.interes_p3, ($scope.infoMoratorio.meses + 12) - 120) * $scope.total3) / ( Math.pow(1 + $scope.infoMoratorio.interes_p3, ($scope.infoMoratorio.meses + 12) - 120)-1);


            var range3=[];

            for (var i = 120; i < $scope.infoMoratorio.plazo; i++) {
                console.log('meses CC', i);
                console.log($scope.alphaNumeric[i-1]);
                console.log('posPay', posPay);
                if(mes == 13){
                    mes = '01';
                    yearc++;
                ...
                if($scope.alphaNumeric[i]['disp'] != 1 || $scope.alphaNumeric[posPay]['disp']==1)
                {
                    ...
                    if (vuelta == posicionPago)
                    {
                        ...
                        {/* Este else es para ver si se descuenta apartir de la segunda posicion*/
                            ...
                            diasRetraso		= $scope.infoMoratorio.diasRetraso	= $scope.alphaNumeric[posPay]['diasRetraso'] = diasRetardo;
                            dispPC		= $scope.infoMoratorio.disp	= $scope.alphaNumeric[posPay]['disp'] = 1;
                            saldoMoraManipulable = saldo = $scope.infoMoratorio.si = $scope.alphaNumeric[i-1]['saldo'];//$scope.alphaNumeric[posPay]['saldo']=saldoInsoluto-$scope.alphaNumeric[posPay]['total']

                            // console.log('importe', importe);
                            // console.log('diasRetraso', diasRetraso);
                            // console.log('dispPC', dispPC);
                            // console.log('saldoMoraManipulable', saldoMoraManipulable);
                            ...
                            // console.log('interes moratorio hereeeee',i,':', IM);
                            // console.log('$scope.alphaNumeric[posPay][\'saldo\'];',i,':', $scope.alphaNumeric[i-1]['saldo']);
                            // console.log('$scope.infoMoratorio.si', $scope.infoMoratorio.si);
                            // console.log('saldo', saldo);
                            if(IM > 0)
                            {
                            ...
                            else
                            {
                                ...
                                console.log('deudaMoratorio', deudaMoratorio);
                                ...
                                if(provA>0){
                                    ...
                                    if(checkMoratorios>0 || checkOrdinarios>0){
                                        ...
                                        deudaOrdinario = $scope.alphaNumeric[posPay]['deudaOrdinario'] = 0;
                                        total = $scope.alphaNumeric[posPay]['total'] = provA;
                                        saldo = $scope.alphaNumeric[i-1]['saldo'] = $scope.alphaNumeric[i-1]['saldo'] - provA;
                                        saldoMoraManipulable = saldo;
                                        console.log('*****CHECK*****');
                                        console.log('deudaOrdinario', deudaOrdinario);
                    ...
                    $scope.interes_plan3 =$scope.alphaNumeric[i]['saldoNormal']* ($scope.infoMoratorio.interes_p3);
            ...
            console.log('vamos a validar aqui que pedo', $scope.alphaNumeric);
            /**/
            // console.log($scope.alphaNumeric);
            $scope.dtoptions = DTOptionsBuilder;
            $scope.dtColumns = [

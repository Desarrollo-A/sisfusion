    ...
    if(i != 0){
        ...
        $('input', this).on('keyup change', function() {
            if (tabla_remanente.column(i).search() !== this.value) {
                ...
                var total = 0;
                var index = tabla_remanente.rows({ selected: true, search: 'applied' }).indexes();
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data) {
                            ...
                            mensaje = "Comisiones de esquema <b>remanente</b>, fueron enviadas a <b>INTERNOMEX</b> correctamente.";
...
$("#tabla_remanente tbody").on("click", ".consultar_logs", function(e){
    ...
    $.getJSON("getHistorial/"+id_pago).done( function( data ){
        $.each( data, function(i, v){
            $("#comentariosRemanente").append('<li><div class="container-fluid"><div class="row"><div class="col-md-6"><a><b>' + v.comentario + '</b></a><br></div><div class="float-end text-right"><a>'+v.fecha_movimiento+'</a></div><div class="col-md-12"><p class="m-0"><small>MODIFICADO POR: </small><b> ' +v.modificado_por+ '</b></p></div><h6></h6></div></div></li>');
        });
    });
});

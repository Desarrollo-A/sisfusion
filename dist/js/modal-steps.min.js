! function(a) {
    ...
    a.fn.modalSteps = function(b) {
        var c = this,
            d = a.extend({
                btnCancelHtml:`${_("cancelar")}`,
                btnPreviousHtml: `${_("anterior")}`,
                btnNextHtml: `${_("siguiente")}`,
                btnLastStepHtml:`${_("siguiente")}`,
                disableNextButton: !1,
                completeCallback: function() {},
                callbacks: {},
                getTitleAndStep: function() {changeSteps();}
            }, b),
            e = function() {
                var a = d.callbacks["*"];
        ...
        return c.on("show.bs.modal", function() {
            var l, m, n, o, p, b = c.find(".modal-footer"),
                ...
                id: "actual-step",
                value: "1"
            }), c.find("#actual-step").remove(), c.append(m), l = 1, p = l + 1, c.find("[data-step=" + l + "]").removeClass("hide"), i.attr("data-step", p), n = c.find("[data-step=" + l + "]").data("title"), o = a("<span>").addClass("label label-success").html(l+"/"+c.find("div[data-step]").length), c.find(".js-title-step").append(o).append(" " + n), d.getTitleAndStep(m.attr("data-title"), l)
            ...
            var m, n, o, p, b = a(this),
                ...
                k = parseInt(e.val()),
                l = d.callbacks["*"];
            if (m = c.find("div[data-step]").length, "complete" === b.attr("data-step")) return d.completeCallback();
            ...
            var q = a("<span>").addClass("label label-success").html(n+"/"+c.find("div[data-step]").length);
